...
public class TestRemoteIpValve {
	...
	public void testInvokeAllowedRemoteAddrWithNullRemoteIpHeader()
		...
		remoteIpValve
				.setInternalProxies("192\\.168\\.0\\.10, 192\\.168\\.0\\.11");
	...
	public void testInvokeAllProxiesAreTrustedAndRemoteAddrMatchRegexp()
		...
		RemoteIpValve remoteIpValve = new RemoteIpValve();
		remoteIpValve
				.setInternalProxies("127\\.0\\.0\\.1|192\\.168\\..*|another-internal-proxy");
		remoteIpValve.setTrustedProxies("proxy1|proxy2|proxy3");
		remoteIpValve.setRemoteIpHeader("x-forwarded-for");
		remoteIpValve.setProxiesHeader("x-forwarded-by");
		RemoteAddrAndHostTrackerValve remoteAddrAndHostTrackerValve = new RemoteAddrAndHostTrackerValve();
	...
	public void testInvokeXforwardedProtoSaysHttpsForIncomingHttpRequest()
		...
		request.getCoyoteRequest().getMimeHeaders()
				.addValue("x-forwarded-proto").setString("https");
		...
		String actualXForwardedFor = request.getHeader("x-forwarded-for");
		assertNull(
				"no intermediate non-trusted proxy, x-forwarded-for must be null",
				actualXForwardedFor);
	...
	@Test
	public void testInvokeXforwardedProtoIsNullForIncomingHttpRequest()
			throws Exception {
	...
	public void testInvokeXforwardedProtoSaysHttpForIncomingHttpsRequest()
		...
		// protocol
		request.getCoyoteRequest().getMimeHeaders()
				.addValue("x-forwarded-proto").setString("http");
