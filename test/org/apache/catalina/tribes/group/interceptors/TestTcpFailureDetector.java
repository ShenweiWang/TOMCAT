...
public class TestTcpFailureDetector {
	...
	public void setUp() throws Exception {
		...
		channel1.getMembershipService().setPayload(
				"Channel-1".getBytes("ASCII"));
		channel2.getMembershipService().setPayload(
				"Channel-2".getBytes("ASCII"));
	...
	public void testTcpSendFailureMemberDrop() throws Exception {
		...
		// Thread.sleep(1000);
		assertEquals("Expecting member count to be equal",
				mbrlist1.members.size(), mbrlist2.members.size());
		...
		assertEquals("Expecting member count to not be equal",
				mbrlist1.members.size() + 1, mbrlist2.members.size());
