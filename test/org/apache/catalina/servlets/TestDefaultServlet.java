...
public class TestDefaultServlet extends TomcatBaseTest {
	...
	public void testGetSpecials() throws Exception {
		...
		rc = getUrl(
				"http://localhost:" + getPort() + contextPath + "/WEB-INF/",
				res, null);
		assertEquals(HttpServletResponse.SC_NOT_FOUND, rc);
	...
	/**
	 * Test https://issues.apache.org/bugzilla/show_bug.cgi?id=50026 Verify
	 * serving of resources from context root with subpath mapping.
	 */
	@Test
	...
	/**
	 * Test what happens if a custom 404 page is configured, but its file is
	 * actually missing.
	 */
	@Test
