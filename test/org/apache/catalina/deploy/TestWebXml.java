...
public class TestWebXml {
	...
	private void doTestValidateVersion(String version) throws IOException,
		...
		Digester digester = DigesterFactory.newDigester(true, true,
				new WebRuleSet(), true);
	...
	// Assuming that global web.xml exists, host-specific web.xml does not
	// exist.
	private WebXml getDefaultWebXmlFragment() throws IOException, SAXException {
		...
		// Assert that web.xml was parsed and is not empty. Default servlet is
		// known to be there.
	...
	public void testLifecycleMethodsWebXml() {
		...
		Map<String, String> postConstructMethods = webxml
