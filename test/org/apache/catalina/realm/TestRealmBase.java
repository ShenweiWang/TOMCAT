...
public class TestRealmBase {
	...
	/**
	 * @param userRoles
	 *            <code>null</code> tests unauthenticated access otherwise
	 *            access is tested with an authenticated user with the listed
	 *            roles
	 * @param constraintRoles
	 *            <code>null</code> is equivalent to no auth constraint whereas
	 *            an empty list is equivalent to an auth constraint that defines
	 *            no roles.
	 */
	...
	private void doRoleTest(List<String> userRoles,
			...
			List<String> applicationRoles, boolean expected) throws IOException {
	...
	public void testHttpConstraint() throws IOException {
		...
		ServletSecurity servletSecurity = clazz
		...
		SecurityConstraint[] constraints = SecurityConstraint
				.createConstraints(servletSecurityElement, "/*");
		...
		SecurityConstraint[] constraintsPost = mapRealm
