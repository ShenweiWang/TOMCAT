...
public class TestNamingContext extends TomcatBaseTest {
	...
	public void testAliases() throws Exception {
		...
		// set up as aliases.
		File tmpDir = new File(getTemporaryDirectory(), "tomcat-unit-test."
		...
		ctx.setAliases("/a1=" + alternate1.getCanonicalPath() + ",/a2="
	...
	public static final class Bug23950Servlet extends HttpServlet {
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp)
			...
			try {
				Context ctx = new InitialContext();
				NamingEnumeration<Binding> enm = ctx
						.listBindings("java:comp/env/list");
				while (enm.hasMore()) {
					Binding b = enm.next();
