...
public class TestUtil {
	...
	public void testGetMessageTypeSimple() {
		Assert.assertEquals(String.class,
				Util.getMessageType(new SimpleMessageHandler()));
	}
	...
	public void testGetMessageTypeGenericMultipleSubclassSwap() {
		Assert.assertEquals(String.class, Util
				.getMessageType(new GenericMultipleSubSubSwapMessageHandler()));
	}
	...
	private abstract static class GenericMessageHandler<T> implements
			MessageHandler.Whole<T> {
	}

	private static class GenericSubMessageHandler extends
			GenericMessageHandler<String> {
	...
	private static class GenericMultipleSubSubSwapMessageHandler extends
			GenericMultipleSubSwapMessageHandler<Boolean, String> {
	...
	private abstract static class GenericArrayEncoder<T> implements
			Encoder.Text<T[]> {
	}

	private static class GenericArrayEncoderString extends
			GenericArrayEncoder<String> {
	...
	private abstract static class GenericArraySubEncoder<T> extends
			GenericArrayEncoder<T[]> {
	}

	private static class GenericArraySubEncoderString extends
			GenericArraySubEncoder<String> {
