...
public class TestEncodingDecoding extends TomcatBaseTest {
	...
	public void testProgrammaticEndPoints() throws Exception {
		...
		ctx.addApplicationListener(ProgramaticServerEndpointConfig.class
				.getName());
	...
	@ClientEndpoint(decoders = { MsgStringDecoder.class, MsgByteDecoder.class }, encoders = {
			MsgStringEncoder.class, MsgByteEncoder.class })
	...
	public static class Server {
		...
		private Queue<Object> received = new ConcurrentLinkedQueue<Object>();
		static HashMap<String, Boolean> lifeCyclesCalled = new HashMap<String, Boolean>(
				8);
	...
	public static class MsgStringMessageHandler implements
			MessageHandler.Whole<MsgString> {
