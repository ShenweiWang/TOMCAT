...
public class TestMapper extends LoggingBaseTest {
	...
	public void setUp() throws Exception {
		...
		mapper.addContextVersion("iowejoiejfoiew", "blah7", "", "0",
				"context0", new String[0], null, null);
		mapper.addContextVersion("iowejoiejfoiew", "blah7", "/foo", "0",
				"context1", new String[0], null, null);
		mapper.addContextVersion("iowejoiejfoiew", "blah7", "/foo/bar", "0",
				"context2", welcomes, null, null);
	...
	public void testAddHost() throws Exception {
		...
		// (added 16 including one host alias. Three duplicates do not increase
		// the count.)
