...
public class TestCookies {
	...
	public void testCookies() throws Exception {
		...
		test("$Version=1;foo=\"bar\";$Domain=apache.org;a=b;$Domain=yahoo.com",
				"foo", "bar", "a", "b");
		// rfc2965
		test("$Version=1;foo=\"bar\";$Domain=apache.org;$Port=8080;a=b", "foo",
				"bar", "a", "b");
	...
	public void testNameOnlyCookies() throws Exception {
		...
		test("fred=1; jim=2; bob; george=3", "fred", "1", "jim", "2", "george",
				"3");
	...
	public static void test(String s, String name, String val, String name2,
			String val2, String name3, String val3, String name4, String val4)
			throws Exception {
		System.out.println("Processing [" + s + "]");
		Cookies cs = new Cookies(null);
		cs.processCookieHeader(s.getBytes(), 0, s.length());
