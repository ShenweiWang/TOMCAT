...
public class TestChunkedInputFilter extends TomcatBaseTest {
	...
	private void doTestChunkingCRLF(boolean chunkHeaderUsesCRLF,
		...
		String[] request = new String[] {
				"POST /echo-params.jsp HTTP/1.1" + SimpleHttpClient.CRLF
						...
						+ (chunkHeaderUsesCRLF ? SimpleHttpClient.CRLF : LF)
						+ "a=0" + (chunkUsesCRLF ? SimpleHttpClient.CRLF : LF)
						+ "4" + SimpleHttpClient.CRLF + "&b=1"
						+ SimpleHttpClient.CRLF + "0" + SimpleHttpClient.CRLF
						+ "x-trailer1: Test",
				"Value1" + (firstheaderUsesCRLF ? SimpleHttpClient.CRLF : LF)
	...
	private void doTestExtensionSizeLimit(int len, boolean ok) throws Exception {
		...
		tomcat.getConnector().setProperty("maxExtensionSize",
				Integer.toString(EXT_SIZE_LIMIT));
