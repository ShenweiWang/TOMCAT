...
public class TestReflectionUtil {
	...
	public void testBug54370a() {
		ReflectionUtil.getMethod(BASE, "testA", new Class[] { null,
	...
	public void testBug54370b() {
		ReflectionUtil.getMethod(BASE, "testB", new Class[] { null,
				String.class }, new Object[] { null, "" });
	}

	@Test
	public void testBug54370c() {
		ReflectionUtil.getMethod(BASE, "testC", new Class[] { null },
				new Object[] { null });
	}

	@Test
	public void testBug54370d() {
		ReflectionUtil.getMethod(BASE, "testD", new Class[] { null },
				new Object[] { null });
	}
}
