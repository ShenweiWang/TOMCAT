...
public class TestSchemaValidation {
	...
	public void testWebapp_2_2() throws Exception {
		...
		Digester digester = DigesterFactory.newDigester(true, true,
				new WebRuleSet(false), true);
		digester.setErrorHandler(handler);
		digester.push(new WebXml());
		WebXml desc = (WebXml) digester.parse(new File(
				"test/webapp-2.2/WEB-INF/web.xml"));
	...
	public void testWebapp_2_3() throws Exception {
		...
		digester.push(new WebXml());
		WebXml desc = (WebXml) digester.parse(new File(
				"test/webapp-2.3/WEB-INF/web.xml"));
	...
	public void testWebapp_2_4() throws Exception {
		...
		digester.push(new WebXml());
		WebXml desc = (WebXml) digester.parse(new File(
				"test/webapp-2.4/WEB-INF/web.xml"));
