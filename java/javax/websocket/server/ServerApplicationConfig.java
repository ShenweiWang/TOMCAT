...
public interface ServerApplicationConfig {
	 ...
	 *
	 * @param scanned
	 *            The {@link Endpoint} implementations found in the application
	 * @return The set of configurations for the endpoint the application wishes
	 *         to deploy
	 */
	 ...
	 *
	 * @param scanned
	 *            The POJOs annotated with {@link ServerEndpoint} found in the
	 *            application
