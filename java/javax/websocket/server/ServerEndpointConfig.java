...
public interface ServerEndpointConfig extends EndpointConfig {
	...
	public final class Builder {
		...
		private Configurator configurator = Configurator
	...
	public class Configurator {
		...
		private static Configurator loadDefault() {
			...
			ServiceLoader<Configurator> serviceLoader = ServiceLoader
			...
			if (result == null) {
				try {
					...
					Class<Configurator> clazz = (Class<Configurator>) Class
							.forName(DEFAULT_IMPL_CLASSNAME);
		...
		public List<Extension> getNegotiatedExtensions(
			...
			return fetchContainerDefaultConfigurator().getNegotiatedExtensions(
					installed, requested);
		}

		public boolean checkOrigin(String originHeaderValue) {
			return fetchContainerDefaultConfigurator().checkOrigin(
					originHeaderValue);
		}
