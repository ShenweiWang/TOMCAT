...
public interface RemoteEndpoint {
	...
	interface Async extends RemoteEndpoint {
		...
		/**
		 * Send the message asynchronously, using the SendHandler to signal to
		 * the client when the message has been sent.
		 * 
		 * @param text
		 *            The text message to send
		 * @param completion
		 *            Used to signal to the client when the message has been
		 *            sent
		 */
	...
	interface Basic extends RemoteEndpoint {
		...
		/**
		 * Sends part of a text message to the remote endpoint. Once the first
		 * part of a message has been sent, no other text or binary messages may
		 * be sent until all remaining parts of this message have been sent.
		 *
		 * @param fragment
