...
public interface ServletContext {
	 ...
	 *             defined in a web.xml file, a web-fragment.xml file nor
	 *             annotated with {@link javax.servlet.annotation.WebListener}.
	 *             For example, a {@link ServletContextListener} defined in a
	 *             TLD would not be able to use this method.
	 *
	 ...
	 *
	 * @param servletName
	 *            The name of the Servlet of interest
	 *
