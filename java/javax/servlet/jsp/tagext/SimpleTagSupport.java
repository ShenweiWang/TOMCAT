 ...
 * <p>
 * The SimpleTagSupport class is a utility class intended to be used as the base
 * class for new simple tag handlers. The SimpleTagSupport class implements the
...
public class SimpleTagSupport implements SimpleTag {
	 ...
	 *
	 * @param jspBody
	 *            The fragment encapsulating the body of this tag. If the action
	 *            element is empty in the page, this method is not called at
	 *            all.
	 ...
	 *
	 * @return the fragment encapsulating the body of this tag, or null if the
	 *         action element is empty in the page.
	 */
	 ...
	 * instance. This method uses the getParent method from the Tag and/or
	 * SimpleTag interfaces. This method is used for coordination among
	 * cooperating tags.
	 *
	 * <p>
	 * For every instance of TagAdapter encountered while traversing the
	 * ancestors, the tag handler returned by <tt>TagAdapter.getAdaptee()</tt> -
	 * instead of the TagAdpater itself - is compared to <tt>klass</tt>. If the
	 * tag handler matches, it - and not its TagAdapter - is returned.
	 *
	 * <p>
	 ...
	 * library author to indicate in the description subelement an observable
	 * type. The type should be a subtype of the tag handler implementation
	 ...
	 *
	 * <p>
	 * When a tag library author provides information on the observable type of
	 * a tag handler, client programmatic code should adhere to that constraint.
	 * Specifically, the Class passed to findAncestorWithClass should be a
	 * subtype of the observable type.
	 * 
	 *
	 * @param from
	...
	public static final JspTag findAncestorWithClass(JspTag from, Class<?> klass) {
		...
		if (from == null
				|| klass == null
				|| (!JspTag.class.isAssignableFrom(klass) && !(isInterface = klass
						.isInterface()))) {
			return null;
		}
