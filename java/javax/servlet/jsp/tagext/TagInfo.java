...
/**
 * Tag information for a tag in a Tag Library; This class is instantiated from
...
public class TagInfo {
	...
	/**
	 * Constructor for TagInfo from data in the JSP 1.1 format for TLD. This
	 * class is to be instantiated only from the TagLibrary code under request
	 * from some JSP code that is parsing a TLD (Tag Library Descriptor).
	 *
	 * Note that, since TagLibibraryInfo reflects both TLD information and
	 * taglib directive information, a TagInfo instance is dependent on a taglib
	 * directive. This is probably a design error, which may be fixed in the
	 * future.
	 *
	 * @param tagName
	 ...
	 * @param tagExtraInfo
	 *            The instance providing extra Tag info. May be null
	 * @param attributeInfo
	...
	/**
	 * Constructor for TagInfo from data in the JSP 1.2 format for TLD. This
	 * class is to be instantiated only from the TagLibrary code under request
	 * from some JSP code that is parsing a TLD (Tag Library Descriptor).
	 *
	 * Note that, since TagLibibraryInfo reflects both TLD information and
	...
	/**
	 * Constructor for TagInfo from data in the JSP 2.0 format for TLD. This
	 * class is to be instantiated only from the TagLibrary code under request
	 * from some JSP code that is parsing a TLD (Tag Library Descriptor).
	 *
	 * Note that, since TagLibibraryInfo reflects both TLD information and
	 ...
	 *            True if supports dynamic attributes
	 *
	 * @since 2.0
	 */
	public TagInfo(String tagName, String tagClassName, String bodycontent,
	...
	/**
	 * Attribute information (in the TLD) on this tag. The return is an array
	 * describing the attributes of this tag, as indicated in the TLD.
	 *
	 * @return The array of TagAttributeInfo for this tag, or a zero-length
	 *         array if the tag has no attributes.
	 */
	...
	/**
	 * Information on the scripting objects created by this tag at runtime. This
	 * is a convenience method on the associated TagExtraInfo class.
	 *
	 * @param data
	...
	/**
	 * Translation-time validation of the attributes. This is a convenience
	 * method on the associated TagExtraInfo class.
	 *
	 * @param data
	...
	/**
	 * The bodycontent information for this tag. If the bodycontent is not
	 * defined for this tag, the default of JSP will be returned.
	 *
	 ...
	 *
	 * Note that a TagLibraryInfo element is dependent not just on the TLD
	 * information but also on the specific taglib instance used. This means
	 * that a fair amount of work needs to be done to construct and initialize
	 * TagLib objects.
	 *
	 * If used carefully, this setter can be used to avoid having to create new
	 ...
	 *
	 * @return Path to a small icon to be displayed by tools, or null if not
	 *         defined
	 */
	 ...
	 *
	 * @return Path to a large icon to be displayed by tools, or null if not
	 *         defined
	 */
