 ...
 *
 * <p>
 * An instance of an Expression can be obtained via from an ExpressionEvaluator
 * instance.
 * </p>
 *
 * <p>
 * An Expression may or not have done a syntactic parse of the expression. A
 * client invoking the evaluate() method should be ready for the case where
 * ELParseException exceptions are raised.
 * </p>
 *
 * @since 2.0
...
public abstract class Expression {
	 ...
	 * validation, but others may not do so. Evaluating the expression may raise
	 * an ELParseException as well as other ELExceptions due to run-time
	 * evaluation.
	 *
	 * @param vResolver
