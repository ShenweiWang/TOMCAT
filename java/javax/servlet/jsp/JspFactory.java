 ...
 * available to a JSP page at runtime for the purposes of creating instances of
 * various interfaces and classes used to support the JSP implementation.
 * <p>
 * A conformant JSP Engine implementation will, during it's initialization
 * instantiate an implementation dependent subclass of this class, and make it
 * globally available for use by JSP implementation classes by registering the
 * instance created with this class via the static
 * <code> setDefaultFactory() </code> method.
 * <p>
...
public abstract class JspFactory {
	...
	/**
	 * <p>
	 * set the default factory for this implementation. It is illegal for any
	 * principal other than the JSP Engine runtime to call this method.
	 * </p>
	 *
	 * @param deflt
	 ...
	 * javax.servlet.jsp.PageContext abstract class for the calling Servlet and
	 * currently pending request and response.
	 * </p>
	 *
	 * <p>
	 * This method is typically called early in the processing of the
	 * _jspService() method of a JSP implementation class in order to obtain a
	 * PageContext object for the request being processed.
	 * </p>
	 * <p>
	 * Invoking this method shall result in the PageContext.initialize() method
	 * being invoked. The PageContext returned is properly initialized.
	 * </p>
	 * <p>
	 * All PageContext objects obtained via this method shall be released by
	 * invoking releasePageContext().
	 * </p>
	 *
	 * @param servlet
	 *            the requesting servlet
	 * @param request
	 *            the current request pending on the servlet
	 * @param response
	 *            the current response pending on the servlet
	 * @param errorPageURL
	 *            the URL of the error page for the requesting JSP, or null
	 * @param needsSession
	 *            true if the JSP participates in a session
	 * @param buffer
	 *            size of buffer in bytes, {@link JspWriter#NO_BUFFER} if no
	 *            buffer, {@link JspWriter#DEFAULT_BUFFER} if implementation
	 *            default.
	 * @param autoflush
	 *            should the buffer autoflush to the output stream on buffer
	 ...
	 * PageContext.release() being invoked. This method should be invoked prior
	 ...
	 * 
	 * @param context
	 *            the current web application's <code>ServletContext</code>
