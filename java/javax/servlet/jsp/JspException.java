 ...
 * result in an invocation of the errorpage machinery.
 */
public class JspException extends Exception {
	...
	/**
	 * Constructs a new JSP exception with the specified message. The message
	 ...
	 *            JSP's normal operation, making this JSP exception necessary
	 */
	...
	/**
	 * Constructs a new <code>JSPException</code> with the specified cause. The
	 * cause is saved for later retrieval by the
	 * <code>java.lang.Throwable.getCause()</code> and {@link #getRootCause()}
	 * methods.
	 * 
	 ...
	 * @param cause
	 *            the <code>Throwable</code> exception that interfered with the
	 *            JSP's normal operation, making the JSP exception necessary
	 */
