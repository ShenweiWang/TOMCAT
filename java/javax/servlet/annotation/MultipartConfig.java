 ...
 * {@code multipart/form-data} MIME type. <br />
 * <br />
 * 
 * {@link javax.servlet.http.Part} components of a given
 * {@code multipart/form-data} request are retrieved by a Servlet annotated with
...
public @interface MultipartConfig {
	...
	/**
	 * @return the maximum size of the request allowed for
