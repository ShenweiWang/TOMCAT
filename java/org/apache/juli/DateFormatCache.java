...
public class DateFormatCache {
	...
	/**
	 * Replace the millisecond formatting character 'S' by some dummy characters
	 * in order to make the resulting formatted time stamps cacheable. Our
	 * consumer might choose to replace the dummy chars with the actual
	...
	private class Cache {
		...
		private String getFormat(long time) {
			...
			/*
			 * First step: if we have seen this timestamp during the previous
			 * call, return the previous value.
			 */
