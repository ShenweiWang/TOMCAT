 ...
 * <code>false</code>, the file will not be rotated and the filename will be
 * <code>{prefix}{suffix}</code>. Default value: <code>true</code></li>
 ...
 * <code>0</code> uses system default buffering (typically an 8K buffer will be
 * used). A value of <code>&lt;0</code> forces a writer flush upon each log
 * write. A value <code>&gt;0</code> uses a BufferedOutputStream with the
 ...
 * value: empty string, which means to use the system default character set.</li>
 * <li><code>level</code> - The level threshold for this Handler. See the
 * <code>java.util.logging.Level</code> class for the possible levels. Default
