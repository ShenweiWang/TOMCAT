...
/**
 * The Member interface, defines a member in the group. Each member can carry a
 * set of properties, defined by the actual implementation.<BR>
 ...
 * feature since a member that has crashed and the starts up again on the same
 * port/host is not guaranteed to be the same member, so no state transfers will
 * ever be confused
 * 
 * @author Filip Hanik
 */
public interface Member {
	 ...
	 * member will be the following bytes. This indicates a soft shutdown, and
	 * not a crash
	 */
	 ...
	 * crashes and restarts, the uniqueId will be different.
	 * 
	 * @return byte[]
	 */
