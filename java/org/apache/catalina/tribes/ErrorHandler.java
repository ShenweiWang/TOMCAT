 ...
 * sent asynchronously and the application still needs to get confirmation when
 * the message was sent successfully or when a message errored out.
 * 
 * @author Filip Hanik
 * @version 1.0
 */
public interface ErrorHandler {
	 ...
	 * 
	 * @param x
	 *            ChannelException - the error that happened
	 * @param id
