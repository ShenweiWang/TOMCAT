...
/**
 * Extension to the {@link RpcCallback} interface. Allows a RPC messenger to get
 * a confirmation if the reply was sent successfully to the original sender.
 * 
 * @author fhanik
 *
 */
public interface ExtendedRpcCallback extends RpcCallback {
	 ...
	 * 
	 * @param request
	 *            - the original message that requested the reply
	 * @param response
	 *            - the reply message to the original message
	 * @param sender
