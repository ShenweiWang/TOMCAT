...
/**
 * The channel coordinator object coordinates the membership service, the sender
 * and the receiver. This is the last interceptor in the chain.
 * 
 * @author Filip Hanik
 */
public class ChannelCoordinator extends ChannelInterceptorBase implements
	...
	public void sendMessage(Member[] destination, ChannelMessage msg,
		...
		if (Logs.MESSAGES.isTraceEnabled()) {
			Logs.MESSAGES.trace("ChannelCoordinator - Sent msg:"
	...
	protected synchronized void internalStart(int svc) throws ChannelException {
		try {
			...
			if (svc == (svc & startLevel))
				throw new ChannelException("Channel already started for level:"
						+ svc);
			...
			if (Channel.SND_RX_SEQ == (svc & Channel.SND_RX_SEQ)) {
				...
				membershipService.setLocalMemberProperties(getClusterReceiver()
						.getHost(), getClusterReceiver().getPort(),
