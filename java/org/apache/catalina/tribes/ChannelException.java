 ...
 * A channel exception is thrown when an internal error happens somewhere in the
 * channel. <br>
 * When a global error happens, the cause can be retrieved using
 * <code>getCause()</code><br>
 * <br>
 * If an application is sending a message and some of the recipients fail to
 * receive it, the application can retrieve what recipients failed by using the
 * <code>getFaultyMembers()</code> method. This way, an application will always
 * know if a message was delivered successfully or not.
 * 
 * @author Filip Hanik
 */
public class ChannelException extends Exception {
	 ...
	 * 
	 * <p>
	 * Description: Represent a failure to a specific member when a message was
	 * sent to more than one member
	 * </p>
	 * 
	 * @author Filip Hanik
	 * @version 1.0
