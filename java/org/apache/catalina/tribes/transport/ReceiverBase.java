...
public abstract class ReceiverBase implements ChannelReceiver, ListenCallback,
	 ...
	 * getMessageListener
	 *
	 * @return MessageListener TODO Implement this
	 *         org.apache.catalina.tribes.ChannelReceiver method
	 */
	@Override
	...
	/**
	 *
	 * @return The port TODO Implement this
	 *         org.apache.catalina.tribes.ChannelReceiver method
	 */
	@Override
	public int getPort() {
	 ...
	 *
	 * @param listener
	 *            MessageListener TODO Implement this
	 *            org.apache.catalina.tribes.ChannelReceiver method
	 */
	@Override
	...
	public InetAddress getBind() {
		if (bind == null) {
			try {
				...
				log.error(
						"Failed bind replication listener on address:" + host,
						ioe);
			}
		}
		return bind;
	 ...
	 * @param retries
	 *            Number of times to attempt to bind (port incremented between
	 *            attempts)
	 * @throws IOException
	 */
	...
	protected int bindUdp(DatagramSocket socket, int portstart, int retries)
		...
		while (retries > 0) {
			try {
				...
				retries--;
				if (retries <= 0) {
					log.info("Unable to bind UDP socket to:" + addr
							+ " throwing error.");
					throw x;
				}
				portstart++;
