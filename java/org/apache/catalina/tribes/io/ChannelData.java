 ...
 * channel interceptor stack and eventually out on a transport to be sent to
 * another node. While the message is being processed by the different
...
public class ChannelData implements ChannelMessage {
	...
	/**
	 * @return returns the message options see
	 *         org.apache.catalina.tribes.Channel
	 *         #sendMessage(org.apache.catalina.tribes.Member[],
	...
	public boolean equals(Object o) {
		if (o instanceof ChannelData) {
			return Arrays
					.equals(getUniqueId(), ((ChannelData) o).getUniqueId());
		} else
			return false;
	}
	...
	/**
	 * Utility method, returns true if the options flag indicates that an ack is
	 * to be sent after the message has been received and processed
	 * 
	 * @param options
	...
	/**
	 * Utility method, returns true if the options flag indicates that an ack is
	 * to be sent after the message has been received but not yet processed
	 * 
	 * @param options
	 *            int - the options for the message
	 * @return boolean
