...
public interface ReplicatedMapEntry extends Serializable {
	 ...
	 * On this method, the object can initialize itself for any data that wasn't
	 * 
	 * @param owner
	 *            Object
	 */
	 ...
	 * number This number increases as modifications are made to the data. The
	 * replicated map can use this to ensure accuracy on a periodic basis
	 * 
