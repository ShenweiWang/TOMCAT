 ...
 * cluster will carry an identical copy of the map.<br>
 * <br>
 ...
 * <br>
 * <br>
 * <b>REMEMBER TO CALL <code>breakdown()</code> or <code>finalize()</code> when
 * you are done with the map to avoid memory leaks.</b><br>
 * <br>
...
public class ReplicatedMap<K, V> extends AbstractReplicatedMap<K, V> {
	 ...
	 */
	public ReplicatedMap(MapOwner owner, Channel channel, long timeout,
