 ...
 * the bottom layer, the IO layer (for layers see the javadoc for the
 * {@link Channel} interface).<br>
 * 
 * @author Filip Hanik
 */
public interface MembershipService {
	 ...
	 * before the <code>start()</code> method is called. The properties are
	 ...
	 * listener will start to receive membership events. Performs a start level
	 * 1 and 2
	 * 
	...
	/**
	 * Starts the membership service. If a membership listeners is added the
	 * listener will start to receive membership events.
	 * 
	 * @param level
	 ...
	 * 
	 * @param level
	 *            - level MBR_RX stops listening for members, level MBR_TX stops
	 *            broad casting the server
	 * @throws java.lang.IllegalArgumentException
	 *             if the level is incorrect.
	 */
	...
	/**
	 * Sets the membership listener, only one listener can be added. If you call
	 * this method twice, the last listener will be used.
	 * 
	 * @param listener
	 *            The listener
	 */
