...
public interface Valve {
	 ...
	 *
	 * @param valve
	 *            The new next valve, or <code>null</code> if none
	 */
	 ...
	 * </p>
	 * <ul>
	 * <li>Change request properties that have already been used to direct the
	 * flow of processing control for this request (for instance, trying to
	 * change the virtual host to which a Request should be sent from a pipeline
	 * attached to a Host or Context in the standard implementation).
	 * <li>Create a completed Response <strong>AND</strong> pass this Request
	 * and Response on to the next Valve in the pipeline.
	 * <li>Consume bytes from the input stream associated with the Request,
	 * unless it is completely generating the response, or wrapping the request
