...
public interface SSIExternalResolver {
	...
	/**
	 * Set the named variable to the specified value. If value is null, then the
	 * variable will be removed ( ie. a call to getVariableValue will return
	 * null )
	 * 
	 * @param name
	 *            of the variable
	 ...
	 * regression test. Since you can make the current date a constant, it makes
	 * testing easier since the output won't change.
	 * 
	 * @return the data
	 */
