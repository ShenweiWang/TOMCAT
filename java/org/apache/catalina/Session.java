 ...
 * <code>HttpSession</code> that is used to maintain state information between
 * requests for a particular user of a web application.
 *
...
public interface Session {
	 ...
	 *            The new session identifier
	 * @param notify
	 *            Should any associated listeners be notified that a new session
	 *            has been created?
	 */
