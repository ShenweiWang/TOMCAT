 ...
 * This makes it convenient to configure a user database in the global JNDI
 * resources associated with this Catalina instance, and then link to that
 * resource for web applications that administer the contents of the user
 * database.
 * </p>
 *
 * <p>
 ...
 * specified by the <code>catalina.base</code> system property) pathname to the
 * XML file from which our user information is loaded, and to which it is
 * stored. [conf/tomcat-users.xml]</li>
 * </ul>
 *
...
public class MemoryUserDatabaseFactory implements ObjectFactory {
	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx,
		...
		ra = ref.get("readonly");
		if (ra != null) {
			database.setReadonly(Boolean.valueOf(ra.getContent().toString())
					.booleanValue());
		}
