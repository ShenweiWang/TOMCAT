...
public class JMXProxyServlet extends HttpServlet {
	...
	private void invokeOperation(PrintWriter writer, String onameStr,
			String op, String[] valuesStr) {
		try {
	 ...
	 * 
	 * @param paramString
	 *            The string containing comma-separated operation-invocation
	 *            parameters, or <code>null</code> if there are no parameters.
	...
	private Object invokeOperationInternal(String onameStr, String operation,
			...
			ReflectionException {
		ObjectName oname = new ObjectName(onameStr);
		MBeanOperationInfo methodInfo = registry
				.getMethodInfo(oname, operation);
