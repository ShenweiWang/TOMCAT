 ...
 * element. This <code>RuleSet</code> does NOT include any rules for nested Host
 * elements, which should be added via instances of <code>HostRuleSet</code>.
 * </p>
 *
...
public class EngineRuleSet extends RuleSetBase {
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addObjectCreate(prefix + "Engine",
				"org.apache.catalina.core.StandardEngine", "className");
		...
		digester.addSetNext(prefix + "Engine/Valve", "addValve",
