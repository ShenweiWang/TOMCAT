...
/**
 * <p>
 * <strong>RuleSet</strong> for processing the contents of a Context definition
 * element.
 * </p>
 *
...
public class ContextRuleSet extends RuleSetBase {
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addObjectCreate(prefix + "Context/Listener", null, // MUST be
																	// specified
																	// in the
																	// element
				"className");
		...
		digester.addObjectCreate(prefix + "Context/Manager/Store", null, // MUST
																			// be
																			// specified
																			// in
																			// the
		...
		digester.addObjectCreate(prefix + "Context/Valve", null, // MUST be
																	// specified
																	// in the
																	// element
				"className");
		...
		digester.addObjectCreate(prefix + "Context/JarScanner",
				"org.apache.tomcat.util.scan.StandardJarScanner", "className");
		digester.addSetProperties(prefix + "Context/JarScanner");
		digester.addSetNext(prefix + "Context/JarScanner", "setJarScanner",
