...
/**
 * The common interface used by all cluster manager. This is so that we can have
 * a more pluggable way of swapping session managers for different algorithms.
 *
 * @author Filip Hanik
