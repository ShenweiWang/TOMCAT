...
public class SerializablePrincipal implements java.io.Serializable {
	...
	public static SerializablePrincipal createPrincipal(
		...
		return new SerializablePrincipal(principal.getName(),
				...
				principal.getRoles() != null ? Arrays.asList(principal
						.getRoles()) : null,
				principal.getUserPrincipal() != principal ? principal
	...
	public static GenericPrincipal readPrincipal(ObjectInput in)
		...
		if (hasUserPrincipal) {
			try {
				...
				log.error(sm
						.getString("serializablePrincipal.readPrincipal.cnfe"),
						e);
				throw e;
			}
		}
	...
	public static void writePrincipal(GenericPrincipal p, ObjectOutput out)
		...
		boolean hasUserPrincipal = (p != p.getUserPrincipal() && p
				.getUserPrincipal() instanceof Serializable);
