...
/**
 * <p>
 * <strong>RuleSet</strong> for processing the contents of a Cluster definition
 * element.
 * </p>
 *
 * @author Filip Hanik
...
public class ClusterRuleSet extends RuleSetBase {
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addObjectCreate(prefix + "Manager", null, // MUST be specified
															// in the element
				"className");
		digester.addSetProperties(prefix + "Manager");
		digester.addSetNext(prefix + "Manager", "setManagerTemplate",
				"org.apache.catalina.ha.ClusterManager");

		digester.addObjectCreate(prefix + "Channel", null, // MUST be specified
															// in the element
				"className");
		digester.addSetProperties(prefix + "Channel");
		digester.addSetNext(prefix + "Channel", "setChannel",
				"org.apache.catalina.tribes.Channel");

		String channelPrefix = prefix + "Channel/";
		{ // channel properties
			digester.addObjectCreate(channelPrefix + "Membership", null, // MUST
																			// be
																			// specified
																			// in
																			// the
			...
			digester.addObjectCreate(channelPrefix + "Sender", null, // MUST be
																		// specified
																		// in
																		// the
																		// element
			...
			digester.addSetNext(channelPrefix + "Sender", "setChannelSender",
					"org.apache.catalina.tribes.ChannelSender");

			digester.addObjectCreate(channelPrefix + "Sender/Transport", null, // MUST
																				// be
																				// specified
																				// in
																				// the
			...
			digester.addObjectCreate(channelPrefix + "Receiver", null, // MUST
																		// be
																		// specified
																		// in
																		// the
			...
			digester.addObjectCreate(channelPrefix + "Interceptor", null, // MUST
																			// be
																			// specified
																			// in
																			// the
			...
			digester.addSetNext(channelPrefix + "Interceptor/Member",
					"addStaticMember", "org.apache.catalina.tribes.Member");
		}

		digester.addObjectCreate(prefix + "Valve", null, // MUST be specified in
															// the element
				"className");
		digester.addSetProperties(prefix + "Valve");
		digester.addSetNext(prefix + "Valve", "addValve",
				"org.apache.catalina.Valve");

		digester.addObjectCreate(prefix + "Deployer", null, // MUST be specified
															// in the element
				"className");
		digester.addSetProperties(prefix + "Deployer");
		digester.addSetNext(prefix + "Deployer", "setClusterDeployer",
				"org.apache.catalina.ha.ClusterDeployer");

		digester.addObjectCreate(prefix + "Listener", null, // MUST be specified
															// in the element
				"className");
		digester.addSetProperties(prefix + "Listener");
		digester.addSetNext(prefix + "Listener", "addLifecycleListener",
				"org.apache.catalina.LifecycleListener");

		digester.addObjectCreate(prefix + "ClusterListener", null, // MUST be
																	// specified
																	// in the
																	// element
				"className");
		digester.addSetProperties(prefix + "ClusterListener");
		digester.addSetNext(prefix + "ClusterListener", "addClusterListener",
