...
public class GenericPrincipal implements Principal {
	 ...
	 *            returned
	 * @param loginContext
	 *            - If provided, this will be used to log out the user at the
	 *            appropriate time
	 */
	public GenericPrincipal(String name, String password, List<String> roles,
	...
	/**
	 * The JAAS LoginContext, if any, used to authenticate this Principal. Kept
	 * so we can call logout().
	 */
	 ...
	 * 
	 * @throws Exception
	 *             If something goes wrong with the logout. Uses Exception to
	 *             allow for future expansion of this method to cover other
	 *             logout mechanisms that might throw a different exception to
	 *             LoginContext
	 * 
	 */
