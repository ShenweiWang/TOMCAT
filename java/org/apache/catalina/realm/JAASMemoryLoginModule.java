...
/**
 * <p>
 * Implementation of the JAAS <strong>LoginModule</strong> interface, primarily
 * for use in testing <code>JAASRealm</code>. It utilizes an XML-format data
 * file of username/password/role information identical to that supported by
 * <code>org.apache.catalina.realm.MemoryRealm</code> (except that digested
 * passwords are not supported).
 * </p>
 *
 * <p>
 * This class recognizes the following string-valued options, which are
 * specified in the configuration file (and passed to our constructor in the
 ...
 * "catalina.base" system property) or absolute pathname to the XML file
 * containing our user information, in the format supported by
 * {@link MemoryRealm}. The default value matches the MemoryRealm default.</li>
 * </ul>
 *
 * <p>
 * <strong>IMPLEMENTATION NOTE</strong> - This class implements
 * <code>Realm</code> only to satisfy the calling requirements of the
 * <code>GenericPrincipal</code> constructor. It does not actually perform the
 * functionality required of a <code>Realm</code> implementation.
 * </p>
 *
...
public class JAASMemoryLoginModule extends MemoryRealm implements LoginModule {
	...
	private static final Log log = LogFactory
			.getLog(JAASMemoryLoginModule.class);
	...
	/**
	 * Phase 2 of authenticating a <code>Subject</code> when Phase 1 fails. This
	 * method is called if the <code>LoginContext</code> failed somewhere in the
	 * overall authentication chain.
	 *
	 ...
	 * successful. This method is called if the <code>LoginContext</code>
