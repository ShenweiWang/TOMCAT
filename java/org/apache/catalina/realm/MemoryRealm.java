 ...
 * collection representing our defined users (and their roles) is initialized at
 * application startup and never modified again. Therefore, no thread
...
public class MemoryRealm extends RealmBase {
	 ...
	 *            User's username
	 * @param password
	 *            User's password (clear text)
	 * @param roles
	 *            Comma-delimited set of roles associated with this user
	 */
	...
	/**
	 * Return a configured <code>Digester</code> to use for processing the XML
	 * input file, creating a new one if necessary.
	 */
