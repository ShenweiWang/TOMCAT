...
public class Connector extends LifecycleMBeanBase {
	...
	public static final boolean RECYCLE_FACADES = Boolean.valueOf(
			System.getProperty("org.apache.catalina.connector.RECYCLE_FACADES",
					"false")).booleanValue();
	...
	public void setParseBodyMethods(String methods) {
		...
		if (methodSet.contains("TRACE")) {
			throw new IllegalArgumentException(
					sm.getString("coyoteConnector.parseBodyMethodNoTrace"));
		}
	...
	public String getProtocol() {
		...
		if ("org.apache.coyote.http11.Http11Protocol"
				.equals(getProtocolHandlerClassName())
				|| "org.apache.coyote.http11.Http11AprProtocol"
						.equals(getProtocolHandlerClassName())) {
			return "HTTP/1.1";
		} else if ("org.apache.coyote.ajp.AjpProtocol"
				.equals(getProtocolHandlerClassName())
	...
	protected void initInternal() throws LifecycleException {
		...
		try {
			...
			throw new LifecycleException(
					sm.getString("coyoteConnector.protocolHandlerInitializationFailed"),
					e);
		}
	...
	protected void destroyInternal() throws LifecycleException {
		...
		try {
			...
			throw new LifecycleException(
					sm.getString("coyoteConnector.protocolHandlerDestroyFailed"),
					e);
		}
