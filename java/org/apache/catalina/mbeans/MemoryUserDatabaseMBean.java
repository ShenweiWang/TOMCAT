...
public class MemoryUserDatabaseMBean extends BaseModelMBean {
	 ...
	 */
	protected ManagedBean managed = registry
			.findManagedBean("MemoryUserDatabase");
