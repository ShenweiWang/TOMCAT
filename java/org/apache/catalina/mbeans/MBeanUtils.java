...
public class MBeanUtils {
	 ...
	 * <code>createManagedBean()</code>. The first element of each pair is a
	 * class name, and the second element is the managed bean name.
	 */
	 ...
	 *
	 * @param component
	 *            The component for which to create a name
	 */
	...
	/**
	 * Create, register, and return an MBean for this <code>MBeanFactory</code>
	 * object.
	 *
	 * @param factory
	...
	/**
	 * Create, register, and return an MBean for this <code>UserDatabase</code>
	 * object.
	 *
	 * @param userDatabase
	...
	/**
	 * Create an <code>ObjectName</code> for this <code>Connector</code> object.
	 *
	 * @param domain
	...
	static ObjectName createObjectName(String domain, Connector connector)
		...
		try {
			Object addressObj = IntrospectionUtils.getProperty(connector,
					"address");
			Integer port = (Integer) IntrospectionUtils.getProperty(connector,
					"port");
			...
			MalformedObjectNameException mone = new MalformedObjectNameException(
	...
	public static ObjectName createObjectName(String domain,
		...
		ObjectName name = null;
		String quotedResourceLinkName = ObjectName
				.quote(resourceLink.getName());
		Object container = resourceLink.getNamingResources().getContainer();
		if (container instanceof Server) {
			name = new ObjectName(domain + ":type=ResourceLink"
					+ ",resourcetype=Global" + ",name="
	...
	/**
	 * Create an <code>ObjectName</code> for this <code>Engine</code> object.
	 *
	 * @param domain
	 *            Domain in which this name is to be created
	 * @param engine
	...
	static ObjectName createObjectName(String domain, Group group)
		...
		name = new ObjectName(domain + ":type=Group,groupname="
				+ ObjectName.quote(group.getGroupname()) + ",database="
	...
	/**
	 * Create an <code>ObjectName</code> for this <code>MBeanFactory</code>
	 * object.
	 *
	 * @param domain
	 *            Domain in which this name is to be created
	...
	static void destroyMBean(Connector connector, Service service)
		...
		ObjectName query = new ObjectName(domain
				+ ":type=RequestProcessor,worker=" + worker + ",*");
	...
	/**
	 * Deregister the MBean for this <code>Context</code> object.
	 *
	 * @param context
	...
	/**
	 * Deregister the MBean for this <code>Host</code> object.
	 *
	 * @param host
	...
	/**
	 * Deregister the MBean for this <code>NamingResources</code> object.
	 *
	 * @param resources
	 *            The NamingResources to be managed
	 *
	...
	/**
	 * Deregister the MBean for this <code>Realm</code> object.
	 *
	 * @param realm
	...
	/**
	 * Deregister the MBean for this <code>Server</code> object.
	 *
	 * @param server
	...
	/**
	 * Deregister the MBean for this <code>Service</code> object.
	 *
	 * @param service
	...
	/**
	 * Deregister the MBean for this <code>UserDatabase</code> object.
	 *
	 * @param userDatabase
	 *            The UserDatabase to be managed
	 *
