 ...
 * <code>org.apache.catalina.core.StandardServer</code> component.
 * </p>
 *
 * @author Amy Roh
 */
public class MBeanFactory {
	...
	/**
	 * Get Parent ContainerBase to add its child component from parent's
	 * ObjectName
	 */
	 ...
	 */
	public String createStandardContext(String parent, String path,
			String docBase, boolean xmlValidation, boolean xmlNamespaceAware,
			boolean tldValidation, boolean tldNamespaceAware) throws Exception {
	...
	public String createStandardHost(String parent, String name,
			String appBase, boolean autoDeploy, boolean deployOnStartup,
			boolean deployXML, boolean unpackWARs) throws Exception {
	...
	public void removeConnector(String name) throws Exception {
		...
		for (int i = 0; i < conns.length; i++) {
			String connAddress = String
					.valueOf(conns[i].getProperty("address"));
	...
	public void removeContext(String contextName) throws Exception {
		...
		String pathStr = getPathStr(path);
		if (mserver.isRegistered(deployer)) {
			mserver.invoke(deployer, "addServiced", new Object[] { pathStr },
					new String[] { "java.lang.String" });
