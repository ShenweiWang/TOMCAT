 ...
 * resource path sets to user classes without having to clone them in order to
 * avoid modifications. When first created, a <code>ResourceMap</code> is not
 * locked.
 *
...
public final class ResourceSet<T> extends HashSet<T> {
	...
	/**
	 * Remove the given element from this set if it is present. Return
	 * <code>true</code> if the element was removed.
	 *
	 * @param o
