...
/**
 * Representation of a Manifest file and its available extensions and required
 * extensions
 * 
 * @author Greg Murray
...
public class ManifestResource {
	...
	/**
	 * Convenience method to check if this <code>ManifestResource</code> has an
	 * requires extensions.
	 *
	...
	/**
	 * Returns <code>true</code> if all required extension dependencies have
	 * been meet for this <code>ManifestResource</code> object.
	 *
	 ...
	 *
	 * @return List of required extensions, or null if the application does not
	...
	private ArrayList<Extension> getAvailableExtensions(Manifest manifest) {
		...
		extension.setImplementationURL(attributes
				.getValue("Implementation-URL"));
		extension.setImplementationVendor(attributes
				.getValue("Implementation-Vendor"));
		extension.setImplementationVendorId(attributes
				.getValue("Implementation-Vendor-Id"));
		extension.setImplementationVersion(attributes
				.getValue("Implementation-Version"));
		extension.setSpecificationVersion(attributes
