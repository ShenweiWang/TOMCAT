 ...
 * JAR file, or the requirement for such an optional package. It is used to
 * support the requirements of the Servlet Specification, version 2.3, related
 * to providing shared extensions to all webapps.
 * <p>
 * In addition, static utility methods are available to scan a manifest and
 * return an array of either available or required optional modules documented
 * in that manifest.
 * <p>
...
public final class Extension {
	 ...
	 * represents an optional package required by this application) is satisfied
	 ...
	 *
	 * @param required
	 *            Extension of the required optional package
	 */
	 ...
	 * @param second
	 *            Second version number (dotted decimal)
	 *
	 * @exception NumberFormatException
	 *                on a malformed version number
	 */
