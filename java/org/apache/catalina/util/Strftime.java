 ...
 *
 * Note: This does not mimic strftime perfectly. Certain strftime commands, are
 * not supported, and will convert as if they were literals.
 *
 ...
 *
 * The interface looks like a subset of DateFormat. Maybe someday someone will
 * make this class extend DateFormat.
 *
 * @author Bip Thelin
 * @author Dan Sandberg
 */
public class Strftime {
	 ...
	 */
	protected boolean translateCommand(StringBuilder buf, String pattern,
