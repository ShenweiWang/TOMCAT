...
/**
 * A thread safe wrapper around {@link MessageDigest} that does not make use of
 * ThreadLocal and - broadly - only creates enough MessageDigest objects to
 * satisfy the concurrency requirements.
 */
