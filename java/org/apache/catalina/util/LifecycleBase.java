...
public abstract class LifecycleBase implements Lifecycle {
	...
	public final synchronized void init() throws LifecycleException {
		...
		try {
			...
			throw new LifecycleException(sm.getString("lifecycleBase.initFail",
					toString()), t);
		}
	...
	public final synchronized void start() throws LifecycleException {
		...
		try {
			...
			throw new LifecycleException(sm.getString(
					"lifecycleBase.startFail", toString()), t);
		}
	...
	public final synchronized void stop() throws LifecycleException {
		...
		try {
			...
			ExceptionUtils.handleThrowable(t);
			setStateInternal(LifecycleState.FAILED, null, false);
			throw new LifecycleException(sm.getString("lifecycleBase.stopFail",
					toString()), t);
		}
	...
	public final synchronized void destroy() throws LifecycleException {
		if (LifecycleState.FAILED.equals(state)) {
			try {
				...
				log.warn(sm.getString("lifecycleBase.destroyStopFail",
						toString()), e);
			}
		}
		...
		try {
			...
			setStateInternal(LifecycleState.FAILED, null, false);
			throw new LifecycleException(sm.getString(
					"lifecycleBase.destroyFail", toString()), t);
		}
