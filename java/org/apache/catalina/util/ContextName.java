...
public final class ContextName {
	 ...
	 * @param name
	 *            The name to use as the basis for this object
	 * @param stripFileExtension
	 *            If a .war or .xml file extension is present at the end of the
	 *            provided name should it be removed?
	 */
	public ContextName(String name, boolean stripFileExtension) {
		...
		if (stripFileExtension
				&& (tmp1.toLowerCase(Locale.ENGLISH).endsWith(".war") || tmp1
