 ...
 * the concurrency control you wish to perform. Note that internally, some async
 * requests may require multiple serial requests to complete what - to the user
 * - appears as a single request.
 * </p>
 *
