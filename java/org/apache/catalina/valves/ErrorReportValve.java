...
public class ErrorReportValve extends ValveBase {
	...
	public void invoke(Request request, Response response) throws IOException,
		...
		if (request.isAsyncStarted()
				&& ((response.getStatus() < 400 && throwable == null) || request
						.isAsyncDispatching())) {
			return;
		}
	...
	protected void report(Request request, Response response,
		...
		if (showReport) {
			...
			if (throwable != null) {
				sb.append(smClient
						.getString("errorReportValve.exceptionReport"));
			} else {
			...
			if (throwable != null) {
				...
				sb.append("</b> <u>");
				sb.append(smClient.getString(
						"errorReportValve.rootCauseInLogs",
	...
	protected String getPartialServletStackTrace(Throwable t) {
		...
		for (int i = 0; i < pos; i++) {
			if (!(elements[i].getClassName()
					.startsWith("org.apache.catalina.core."))) {
