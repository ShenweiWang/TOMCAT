 ...
 * therefore an individual web application, in the Catalina servlet engine. It
 * is therefore useful in almost every deployment of Catalina (even if a
 * Connector attached to a web server (such as Apache) uses the web server's
 * facilities to identify the appropriate Wrapper to handle this request. It
 * also provides a convenient mechanism to use Interceptors that see every
 * request processed by this particular web application.
 * <p>
 * The parent Container attached to a Context is generally a Host, but may be
 * some other implementation, or may be omitted if it is not necessary.
 * <p>
 * The child containers attached to a Context are generally implementations of
 * Wrapper (representing individual servlet definitions).
 * <p>
 *
...
public interface Context extends Container {
	 ...
	 *
	 * @param sessionCookiePathUsesTrailingSlash
	 *            <code>true</code> if the slash is should be added, otherwise
	 *            <code>false</code>
	 */
	...
	/**
	 * Controls whether the parsing of web.xml and web-fragment.xml files for
	 * this Context will be performed by a validating parser.
	 *
	 * @param xmlValidation
	 ...
	 *
	 * @param containerSciFilter
	 *            The regular expression against which the fully qualified class
	 *            name of each container provided SCI should be checked
	 */
	...
	/**
	 * Add a new context initialization parameter, replacing any existing value
	...
	/**
	 * Return the set of security constraints for this web application. If there
	 ...
	 * 
	 * @param registration
	 *            servlet security was modified for
	 * @param servletSecurityElement
	 ...
	 * @return <code>true</code> if the Servlet expects a resource, otherwise
	 *         <code>false</code>
	 */
	...
	/**
	 * Set the version of this web application - used to differentiate different
	 * versions of the same web application when using parallel deployment.
	 */
	public void setWebappVersion(String webappVersion);

	/**
	 * Set the version of this web application - used to differentiate different
	 * versions of the same web application when using parallel deployment. If
	 * not specified, defaults to the empty string.
	 */
