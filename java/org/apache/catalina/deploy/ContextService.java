 ...
 * represented in a <code>&lt;service-ref&gt;</code> element in the deployment
 * descriptor.
 *
...
public class ContextService extends ResourceBase {
	...
	/**
	 * Contains the location (relative to the root of the module) of the web
	...
	/**
	 * A file specifying the correlation of the WSDL definition to the
	 * interfaces (Service Endpoint Interface, Service Interface).
	 */
	 ...
	 * is not specified if no wsdl-file is declared or if WSDL contains only 1
	 * service element.
	 *
	 * A service-qname is composed by a namespaceURI and a localpart. It must be
	 * defined if more than 1 service is declared in the WSDL.
	 *
	 ...
	 * Endpoint Interface to a WSDL port. It optionally associates the Service
	 * Endpoint Interface with a particular port-component.
	 *
	 */
	 ...
	 */
	private final HashMap<String, ContextHandler> handlers = new HashMap<String, ContextHandler>();
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((jaxrpcmappingfile == null) ? 0 : jaxrpcmappingfile
						.hashCode());
		result = prime * result
