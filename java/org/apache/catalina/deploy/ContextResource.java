...
/**
 * Representation of a resource reference for a web application, as represented
 * in a <code>&lt;resource-ref&gt;</code> element in the deployment descriptor.
 *
...
public class ContextResource extends ResourceBase {
	...
	/**
	 * The authorization requirement for this resource (<code>Application</code>
	...
	/**
	 * The sharing scope of this resource factory (<code>Shareable</code> or
	 * <code>Unshareable</code>).
	 */
	...
	/**
	 * The name of the zero argument method to be called when the resource is no
	 * longer required to clean-up resources. This method must only speed up the
	 * clean-up of resources that would otherwise happen via garbage collection.
	 */
