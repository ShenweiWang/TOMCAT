 ...
 * Valve that logs access requests so requests that are rejected earlier in the
 * processing chain can still be added to the access log. Implementations of
 * this interface should be robust against the provided {@link Request} and
 * {@link Response} objects being null, having null attributes or any other
 * 'oddness' that may result from attempting to log a request that was almost
 * certainly rejected because it was mal-formed.
 */
public interface AccessLog {
	 ...
	 * which will otherwise log the original values. Default is
	 * <code>true</code>.
	 *
