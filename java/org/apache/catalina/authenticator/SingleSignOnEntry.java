...
/**
 * A class that represents entries in the cache of authenticated users. This is
 * necessary to make it available to <code>AuthenticatorBase</code> subclasses
 * that need it in order to perform reauthentications when SingleSignOn is in
 * use.
 *
...
public class SingleSignOnEntry {
	...
	/**
	 * Removes the given <code>Session</code> from the list of those associated
	 * with this SSO.
	 *
	 * @param session
	 *            the <code>Session</code> to remove.
	 */
	 ...
	 *
	 * @return <code>true</code> if <code>getAuthType</code> returns "BASIC" or
	 *         "FORM", <code>false</code> otherwise.
	 */
	 ...
	 *         <code>null</code> if the original authentication type does not
	 *         involve a password.
	 */
	...
	/**
	 * Updates the SingleSignOnEntry to reflect the latest security information
	...
	public void updateCredentials(Principal principal, String authType,
		...
		this.canReauthenticate = (HttpServletRequest.BASIC_AUTH
				.equals(authType) || HttpServletRequest.FORM_AUTH
				.equals(authType));
	}
