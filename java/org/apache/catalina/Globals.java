...
public final class Globals {
	 ...
	 * connector processing this request supports Comet API. Duplicated here for
	 * neater code in the catalina packages.
	 */
	public static final String COMET_SUPPORTED_ATTR = org.apache.coyote.Constants.COMET_SUPPORTED_ATTR;

	/**
	 * The request attribute that is set to the value of {@code Boolean.TRUE} if
	 * connector processing this request supports setting per-connection request
	 * timeout through Comet API.
	 *
	 ...
	 * {@code java.lang.Integer} to specify per-connection request timeout for
	 * Comet API. The value is in milliseconds.
	 *
	 * @see org.apache.catalina.comet.CometEvent#setTimeout(int)
	 *
	 *      Duplicated here for neater code in the catalina packages.
	...
	/**
	 * The request attribute that is set to the value of {@code Boolean.TRUE} if
	 * connector processing this request supports use of sendfile.
	 *
	 * Duplicated here for neater code in the catalina packages.
	 */
	...
	/**
	 * The request attribute that can be used by a servlet to pass to the
	 * connector the name of the file that is to be served by sendfile. The
	 * value should be {@code java.lang.String} that is
	 * {@code File.getCanonicalPath()} of the file to be served.
	 *
	 * Duplicated here for neater code in the catalina packages.
	 */
	 ...
	 * sendfile. The value should be {@code java.lang.Long}. To serve complete
	 * file the value should be {@code Long.valueOf(0)}.
	 *
	 * Duplicated here for neater code in the catalina packages.
	 */
	...
	/**
	 * The request attribute that can be used by a servlet to pass to the
	 * connector the end offset (not including) of the part of a file that is to
	 * be served by sendfile. The value should be {@code java.lang.Long}. To
	 * serve complete file the value should be equal to the length of the file.
	 *
	 * Duplicated here for neater code in the catalina packages.
	 */
