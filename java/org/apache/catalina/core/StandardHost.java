...
public class StandardHost extends ContainerBase implements Host {
	 ...
	 * relative pathname, or a URL. If null, defaults to
	...
	public void setDeployIgnore(String deployIgnore) {
		...
		support.firePropertyChange("deployIgnore", oldDeployIgnore,
				deployIgnore);
	}
	...
	public String[] findReloadedContextMemoryLeaks() {
		...
		for (Map.Entry<ClassLoader, String> entry : childClassLoaders
				.entrySet()) {
	...
	protected synchronized void startInternal() throws LifecycleException {
		...
		if ((errorValve != null) && (!errorValve.equals(""))) {
			try {
				...
				if (!found) {
					Valve valve = (Valve) Class.forName(errorValve)
							.newInstance();
				...
				log.error(sm
						.getString("standardHost.invalidErrorReportValveClass",
								errorValve), t);
			}
		}
		super.startInternal();
