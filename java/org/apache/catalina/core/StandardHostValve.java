...
final class StandardHostValve extends ValveBase {
	...
	static {
		...
		String accessSession = System
				.getProperty("org.apache.catalina.core.StandardHostValve.ACCESS_SESSION");
	...
	public final void invoke(Request request, Response response)
		...
		if (asyncAtStart || context.fireRequestInitEvent(request)) {
			...
			try {
				...
				if (errorAtStart) {
					container.getLogger().error(
							"Exception Processing " + request.getRequestURI(),
							t);
				} else {
			...
			// place
			if (!(request.isAsync() || (asyncAtStart && request
					.getAttribute(RequestDispatcher.ERROR_EXCEPTION) != null))) {
