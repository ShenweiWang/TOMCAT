...
/**
 * Wrapper around a <code>javax.servlet.http.HttpServletResponse</code> that
 * transforms an application response object (which might be the original one
 * passed to a servlet, or might be based on the 2.3
 * <code>javax.servlet.http.HttpServletResponseWrapper</code> class) back into
 * an internal <code>org.apache.catalina.HttpResponse</code>.
 * <p>
