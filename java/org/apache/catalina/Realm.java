...
public interface Realm {
	...
	/**
	 * Return the Principal associated with the specified {@link GSSContext}. If
	 * there is none, return <code>null</code>.
	 *
	 * @param gssContext
	 *            The gssContext processed by the {@link Authenticator}.
	 * @param storeCreds
	 *            Should the realm attempt to store the delegated credentials in
	 ...
	 *
	 * @param wrapper
	 *            wrapper context for evaluating role
	 * @param principal
