...
public abstract class StreamInbound implements UpgradeInbound {
	...
	/**
	 * Intended to be overridden by sub-classes that wish to be notified when
	 * the outbound connection is established. The default implementation is a
	 * NO-OP.
	 *
	 * @param outbound
	...
	/**
	 * Intended to be overridden by sub-classes that wish to be notified when
	 * the outbound connection is closed. The default implementation is a NO-OP.
	 *
	 * @param status
	 *            The status code of the close reason.
	 */
	...
	/**
	 * Intended to be overridden by sub-classes that wish to be notified when a
	 * pong is received. The default implementation is a NO-OP.
	 *
	 * @param payload
	 *            The payload included in the pong.
	 */
	 ...
	 *
	 * @throws IOException
	 *             If a problem occurs processing the message. Any exception
	 *             will trigger the closing of the WebSocket connection.
	 */
