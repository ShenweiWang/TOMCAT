...
public class WsOutbound {
	...
	public WsOutbound(UpgradeOutbound upgradeOutbound,
			StreamInbound streamInbound, int byteBufferSize, int charBufferSize) {
	 ...
	 *
	 * @param b
	 *            The byte (only the least significant byte is used) of data to
	 *            send to the client.
	 *
	 * @throws IOException
	 *             If a flush is required and an error occurs writing the
	 ...
	 *
	 * @param frame
	 *            The close frame received from a client
	 *
	 * @throws IOException
	 *             If an error occurs writing to the client
	 */
	 ...
	 *
	 * @param status
	 *            Must be a valid status code or zero to send no code
	 * @param data
	 *            Optional message. If message is defined, a valid status code
	 *            must be provided.
	 *
	 * @throws IOException
	 *             If an error occurs writing to the client
	 ...
	 *             If an error occurs writing to the client
	 */
	private void sendControlMessage(ByteBuffer data, byte opcode)
			throws IOException {
