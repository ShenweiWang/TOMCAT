...
/**
 * <p>
 * Implementation of a Filter that logs interesting contents from the specified
...
public class RequestDumperFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		doLog("     contentLength", Integer.valueOf(request.getContentLength())
				.toString());
		...
		doLog("        serverPort", Integer.valueOf(request.getServerPort())
				.toString());
		...
		if (hResponse == null) {
			...
			doLog("            status", Integer.valueOf(hResponse.getStatus())
					.toString());
		}
