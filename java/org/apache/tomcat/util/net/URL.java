...
/**
 * <p>
 * <strong>URL</strong> is designed to provide public APIs for parsing and
 * synthesizing Uniform Resource Locators as similar as possible to the APIs of
 * <code>java.net.URL</code>, but without the ability to open a stream or
 * connection. One of the consequences of this is that you can construct URLs
 * for protocols for which a URLStreamHandler is not available (such as an
 * "https" URL when JSSE is not installed).
 * </p>
 *
 * <p>
 * <strong>WARNING</strong> - This class assumes that the string representation
 * of a URL conforms to the <code>spec</code> argument as described in RFC 2396
 ...
 *
 * <p>
 * <strong>FIXME</strong> - This class really ought to end up in a Commons
 * package someplace.
 * </p>
 *
...
public final class URL implements Serializable {
	 ...
	 * <code>URLs</code> are equal if they have the same protocol and reference
	 * the same host, the same port number on the host, and the same file and
	 * anchor on the host.
	 *
	 * @param obj
