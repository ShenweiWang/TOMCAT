...
public abstract class ParameterAnnotations extends Attribute {
	 ...
	 *            Array of constants
	 */
	ParameterAnnotations(byte parameter_annotation_type, int name_index,
			int length, DataInputStream file, ConstantPool constant_pool)
			throws IOException {
		this(parameter_annotation_type, name_index, length,
				(ParameterAnnotationEntry[]) null, constant_pool);
	 ...
	 * @param length
	 *            Content length in bytes
	 * @param parameter_annotation_table
	 *            the actual parameter annotations
	 * @param constant_pool
	 *            Array of constants
	 */
	public ParameterAnnotations(byte parameter_annotation_type, int name_index,
			int length, ParameterAnnotationEntry[] parameter_annotation_table,
