 ...
 */
public class JavaClass extends AccessFlags implements Cloneable,
	...
	// Annotations are collected from certain attributes, don't do it more than
	// necessary!
		...
		if (annotationsOutOfDate) {
			...
			for (Attribute attribute : attrs) {
				if (attribute instanceof Annotations) {
					...
					for (int j = 0; j < runtimeAnnotations
							.getAnnotationEntries().length; j++)
						accumulatedAnnotations.add(runtimeAnnotations
