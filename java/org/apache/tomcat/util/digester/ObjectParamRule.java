...
public class ObjectParamRule extends Rule {
	// ----------------------------------------------------------- Constructors
	/**
	 * Construct a "call parameter" rule that will save the given Object as the
	 * parameter value.
	 *
	 * @param paramIndex
	...
	/**
	 * Construct a "call parameter" rule that will save the given Object as the
	 * parameter value, provided that the specified attribute exists.
	 *
	 * @param paramIndex
	 *            The zero-relative parameter number
	 * @param attributeName
	...
	public void begin(String namespace, String name, Attributes attributes)
		...
		if (attributeName != null) {
			...
			// note -- if attributeName != null and anAttribute == null, this
			// rule
