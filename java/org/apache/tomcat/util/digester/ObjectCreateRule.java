...
public class ObjectCreateRule extends Rule {
	...
	/**
	 * Construct an object create rule with the specified class and an optional
	 * attribute name containing an override.
	 *
	 * @param attributeName
	 *            Attribute name which, if present, contains an
	 * @param clazz
	 *            Java class name of the object to be created override of the
	 *            class name to create
	 */
