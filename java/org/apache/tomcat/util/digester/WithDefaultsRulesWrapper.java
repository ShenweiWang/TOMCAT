...
/**
 * <p>
 * <code>Rules</code> <em>Decorator</em> that returns default rules when no
 * matches are returned by the wrapped implementation.
 * </p>
 *
 * <p>
 * This allows default <code>Rule</code> instances to be added to any existing
...
public class WithDefaultsRulesWrapper implements Rules {
	 ...
	 *
	 * @param wrappedRules
	 *            the wrapped <code>Rules</code> implementation, not null
	 * @throws IllegalArgumentException
	 *             when <code>wrappedRules</code> is null
	 */
	...
	/**
	 * Gets Rule's which will be fired when the wrapped implementation returns
	 * no matches
	 */
	...
	/**
	 * Return list of rules matching given pattern. If wrapped implementation
	 * returns any matches return those. Otherwise, return default matches.
	 */
	@Override
	...
	/**
	 * Adds a Rule to be fired on given pattern. Pattern matching is delegated
	 * to wrapped implementation.
	 */
	@Override
