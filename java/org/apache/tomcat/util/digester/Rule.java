...
public abstract class Rule {
	 ...
	 *
	 * @param namespaceURI
	 *            Namespace URI for which this Rule is relevant, or
	 *            <code>null</code> to match independent of namespace.
	 */
	 ...
	 * @deprecated Use the {@link #begin(String,String,Attributes) begin} method
	...
	/**
	 * This method is called when the beginning of a matching XML element is
	 * encountered. The default implementation delegates to the deprecated
	 ...
	 * @deprecated Use the {@link #body(String,String,String) body} method with
	 *             <code>namespace</code> and <code>name</code> parameters
	 *             instead.
	 */
	@Deprecated
	 ...
	 * This method is called when the end of a matching XML element is
	 * encountered. The default implementation delegates to the deprecated
	 * method {@link #end end} without the <code>namespace</code> and
	 * <code>name</code> parameters, to retain backwards compatibility.
	 *
	 * @param namespace
	 *            the namespace URI of the matching element, or an empty string
