...
public class SetTopRule extends Rule {
	 ...
	 *             {@link #SetTopRule(String methodName)} instead.
	 */
	@Deprecated
	 ...
	 *            Method name of the "set parent" method to call
	 * @param paramType
	 *            Java class of the "set parent" method's argument (if you wish
	 *            to use a primitive type, specify the corresponding Java
	 *            wrapper class instead, such as <code>java.lang.Boolean</code>
	 *            for a <code>boolean</code> parameter)
	 *
	 * @deprecated The digester instance is now set in the
	 *             {@link Digester#addRule} method. Use
	 *             {@link #SetTopRule(String methodName, String paramType)}
	 *             instead.
	 */
	@Deprecated
		...
		if (digester.log.isDebugEnabled()) {
			if (child == null) {
				digester.log.debug("[SetTopRule]{" + digester.match
						+ "} Call [NULL CHILD]." + methodName + "(" + parent
						+ ")");
			} else {
				digester.log.debug("[SetTopRule]{" + digester.match + "} Call "
						+ child.getClass().getName() + "." + methodName + "("
						+ parent + ")");
			}
		}

		// Call the specified method
		IntrospectionUtils.callMethod1(child, methodName, parent, paramType,
