...
/**
 * Rule implementation that sets an individual property on the object at the top
 * of the stack, based on attributes with specified names.
 */
...
public class SetPropertyRule extends Rule {
	 ...
	 *            property to be set
	 * @param value
	 *            Name of the attribute that will contain the value to which the
	 *            property should be set
	 *
	 * @deprecated The digester instance is now set in the
	 *             {@link Digester#addRule} method. Use
	 *             {@link #SetPropertyRule(String name, String value)} instead.
	 */
	@Deprecated
	 ...
	 *                if the bean does not have a writable property of the
	 *                specified name
	 */
	@Override
	public void begin(String namespace, String theName, Attributes attributes)
		...
		if (digester.log.isDebugEnabled()) {
			digester.log.debug("[SetPropertyRule]{" + digester.match + "} Set "
					+ top.getClass().getName() + " property " + actualName
					+ " to " + actualValue);
		}
