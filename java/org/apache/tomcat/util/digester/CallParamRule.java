 ...
 * <ul>
 * <li>from an attribute of the current element See
 * {@link #CallParamRule(int paramIndex, String attributeName)}
 * <li>from current the element body See {@link #CallParamRule(int paramIndex)}
 * <li>from the top object on the stack. See
 * {@link #CallParamRule(int paramIndex, boolean fromStack)}
 * <li>the current path being processed (separate <code>Rule</code>). See
 * {@link PathCallParamRule}
 * </ul>
 * </p>
 */
...
public class CallParamRule extends Rule {
	 ...
	 * If the stack contains too few objects, then the parameter will be set to
	 * null.
	 *
	 * @param paramIndex
	 *            The zero-relative parameter number
