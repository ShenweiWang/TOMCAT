...
public class ManagedBean implements java.io.Serializable {
	...
	/**
	 * The fully qualified name of the Java class of the MBean described by this
	 * descriptor. If not specified, the standard JMX class (
	 * <code>javax.management.modelmbean.RequiredModeLMBean</code>) will be
	 * utilized.
	 */
	...
	/**
	 * The (optional) <code>ObjectName</code> domain in which this MBean should
	 * be registered in the MBeanServer.
	 */
	...
	/**
	 * <p>
	 * Return a <code>List</code> of the {@link FieldInfo} objects for the
	 * name/value pairs that should be added to the Descriptor created from this
	 * metadata.
	 * </p>
	 */
	...
	/**
	 * The name of this managed bean, which must be unique among all MBeans
	 * managed by a particular MBeans server.
	 */
	...
	/**
	 * The fully qualified name of the Java class of the resource implementation
	 * class described by the managed bean described by this descriptor.
	 */
	...
	/**
	 * <p>
	 * Add a new field to the fields associated with the Descriptor that will be
	 ...
	 * with the <code>ModelMBeanInfo</code> information for this managed bean,
	 * but is not associated with any particular managed resource. The returned
	 ...
	 *                if a problem occurs instantiating the
	 *                <code>ModelMBean</code> instance
	 * @exception RuntimeOperationsException
	 *                if a JMX runtime error occurs
	 */
	public DynamicMBean createMBean() throws InstanceNotFoundException,
	 ...
	 * Create and return a <code>ModelMBean</code> that has been preconfigured
	 * with the <code>ModelMBeanInfo</code> information for this managed bean,
	 * and is associated with the specified managed object instance. The
	 * returned <code>ModelMBean</code> will <strong>NOT</strong> have been
	 * registered with our <code>MBeanServer</code>.
	 *
	 * @param instance
	 *            Instanced of the managed object, or <code>null</code> for no
	 *            associated instance
	 *
	 * @exception InstanceNotFoundException
	 *                if the managed resource object cannot be found
	...
	public DynamicMBean createMBean(Object instance)
		...
		if (getClassName().equals(BASE_MBEAN)) {
			...
			if (clazz == null) {
				throw new MBeanException(ex, "Cannot load ModelMBean class "
						+ getClassName());
			}
			try {
	...
	MBeanInfo getMBeanInfo() {
		...
		info = new MBeanInfo(getClassName(), getDescription(), attributes,
				new MBeanConstructorInfo[] {}, operations, notifications);
		// try {
	...
	public Method getSetter(String aname, BaseModelMBean bean, Object resource)
		...
		Class<?> signature[] = new Class[] { BaseModelMBean
				.getAttributeClass(argType) };
	...
	public Method getInvoke(String aname, Object[] params, String[] signature,
			BaseModelMBean bean, Object resource) throws MBeanException,
			ReflectionException {
		...
		if (opInfo == null)
			throw new MBeanException(new ServiceNotFoundException(
					"Cannot find operation " + aname), "Cannot find operation "
					+ aname);
