...
/**
 * <p>
 * Basic implementation of the <code>DynamicMBean</code> interface, which
 * supports the minimal requirements of the interface contract.
 * </p>
 *
 * <p>
 * This can be used directly to wrap an existing java bean, or inside an mlet or
 * anywhere an MBean would be used.
 *
 * Limitations:
 * <ul>
 * <li>Only managed resources of type <code>objectReference</code> are
 * supported.</li>
 * <li>Caching of attribute values and operation results is not supported. All
 * calls to <code>invoke()</code> are immediately executed.</li>
 ...
 * <ul>
 * <li>One of the Java primitive types (boolean, byte, char, double, float,
 * integer, long, short). Corresponding value will be wrapped in the appropriate
 * wrapper class automatically.</li>
...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration,
	 ...
	 *                if this attribute is not supported by this MBean
	 * @exception MBeanException
	 *                if the initializer of an object throws an exception
	 * @exception ReflectionException
	 *                if a Java reflection exception occurs when invoking the
	 *                getter
	 */
	@Override
		...
		try {
			...
			if (t instanceof RuntimeException)
				throw new RuntimeOperationsException((RuntimeException) t,
						"Exception invoking method " + name);
	 ...
	 * to invoke this method on the MBean itself, or (if not available) on the
	 * managed resource object associated with this MBean.
	 * </p>
	 *
	 * @param name
	 *            Name of the operation to be invoked
	 * @param params
	 *            Array containing the method parameters of this operation
	 * @param signature
	 *            Array containing the class names representing the signature of
	 *            this operation
	 *
	 * @exception MBeanException
	 *                if the initializer of an object throws an exception
	 * @exception ReflectionException
	 *                if a Java reflection exception occurs when invoking a
	 *                method
	 */
	@Override
	public Object invoke(String name, Object params[], String signature[])
		...
		if (name == null)
			throw new RuntimeOperationsException(new IllegalArgumentException(
					"Method name is null"), "Method name is null");
	...
	static Class<?> getAttributeClass(String signature)
		...
		if (signature.equals(Boolean.TYPE.getName()))
			...
			try {
				...
				throw new ReflectionException(e, "Cannot find Class for "
						+ signature);
			}
		}
	}
	 ...
	 *
	 * @param attribute
	 *            The identification of the attribute to be set and the new
	 *            value
	 *
	 * @exception AttributeNotFoundException
	 *                if this attribute is not supported by this MBean
	...
	public Object getManagedResource() throws InstanceNotFoundException,
		...
		if (resource == null)
			throw new RuntimeOperationsException(new IllegalArgumentException(
					"Managed resource is null"), "Managed resource is null");
	 ...
	 * resource can implement this method to get a reference to the model mbean.
	 * The reference can be used to send notification and access the registry.
	 * </strike> The caller can provide the mbean instance or the object name to
	 * the resource, if needed.
	 *
	 * @param resource
	 *            The resource object to be managed
	 * @param type
	...
	public void sendAttributeChangeNotification(
		...
		if (notification == null)
			throw new RuntimeOperationsException(new IllegalArgumentException(
					"Notification is null"), "Notification is null");
		if (attributeBroadcaster == null)
	 ...
	 *
	 * @param notification
	 *            The <code>Notification</code> that will be passed
	 *
	 * @exception MBeanException
	 *                if an object initializer throws an exception
	 * @exception RuntimeOperationsException
	...
	/**
	 * Send a <code>Notification</code> which contains the specified string as a
	 * <code>jmx.modelmbean.generic</code> notification.
	 *
	 * @param message
	 ...
	 *
	 * @param listener
	 *            The listener to be removed (any and all registrations for this
