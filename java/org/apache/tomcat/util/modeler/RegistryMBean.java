...
public interface RegistryMBean {
	 ...
	 *            List of ObjectNames
	 * @param operation
	 *            Operation to perform. Typically "init" "start" "stop" or
	 *            "destroy"
	 * @param failFirst
	 *            Behavior in case of exceptions - if false we'll ignore errors
	 * @throws Exception
	 */
	 ...
	 * reloading. Existing mbeans will not be affected or modified.
	 * 
