...
public class Registry implements RegistryMBean, MBeanRegistration {
	...
	private Hashtable<String, Hashtable<String, Integer>> idDomains = new Hashtable<String, Hashtable<String, Integer>>();
	 ...
	 *
	 * Use this method to obtain a Registry - all other static methods are
	 ...
	 * @param guard
	 *            Prevent access to the registry by untrusted components
	 *
	 * @since 1.1
	 */
	...
	/**
	 * Allow containers to isolate apps. Can be called only once. It is highly
	 * recommended you call this method if using Registry in a container
	 * environment. The default is false for backward compatibility
	 * 
	 * @param enable
	 * @since 1.1
	 */
	 ...
	 *
	 * @param source
	 *            InputStream or URL of the file
	 * @param cl
	 ...
	 *
	 * @param name
	 *            Name of the managed bean to be returned. Since 1.1, both short
	 *            names or the full name of the class can be used.
	 * @since 1.0
	 */
	...
	/**
	 * Return the set of bean names for all managed beans known to this
	 * registry.
	 *
	 * @since 1.0
	 */
	 ...
	 *
	 * @param group
	 *            Name of the group of interest, or <code>null</code> to select
	 *            beans that do <em>not</em> belong to a group
	 * @since 1.0
	 */
	 ...
	 *
	 * @param bean
	 *            The managed bean to be removed
	 * @since 1.0
	 */
	...
	public ManagedBean findManagedBean(Object bean, Class<?> beanClass,
		...
		if (managed == null) {
			...
			// introspection
			loadDescriptors("MbeansDescriptorsIntrospectionSource", beanClass,
					type);
	 ...
	 * 
	 * @param type
	 *            Fully qualified class name of the resulting value
	 * @param value
	...
	/**
	 * Set the <code>MBeanServer</code> to be utilized for our registered
	 * management beans.
	 *
	 * @param server
	 *            The new <code>MBeanServer</code> instance
	 */
