...
public class MbeansDescriptorsDigesterSource extends ModelerSource {
	private static final Log log = LogFactory
			.getLog(MbeansDescriptorsDigesterSource.class);
	...
	protected static Digester createDigester() {
		...
		digester.addObjectCreate("mbeans-descriptors/mbean",
				"org.apache.tomcat.util.modeler.ManagedBean");
		digester.addSetProperties("mbeans-descriptors/mbean");
		digester.addSetNext("mbeans-descriptors/mbean", "add",
				"java.lang.Object");
		...
		digester.addSetNext("mbeans-descriptors/mbean/attribute",
				"addAttribute", "org.apache.tomcat.util.modeler.AttributeInfo");
		 ...
		 * ("mbeans-descriptors/mbean/attribute/descriptor/field");
		 * digester.addSetNext
		 * ("mbeans-descriptors/mbean/attribute/descriptor/field", "addField",
		 * "org.apache.tomcat.util.modeler.FieldInfo");
		 * 
		 * digester.addObjectCreate ("mbeans-descriptors/mbean/constructor",
		 * "org.apache.tomcat.util.modeler.ConstructorInfo");
		 * digester.addSetProperties ("mbeans-descriptors/mbean/constructor");
		 * digester.addSetNext ("mbeans-descriptors/mbean/constructor",
		 * "addConstructor", "org.apache.tomcat.util.modeler.ConstructorInfo");
		 * 
		 * digester.addObjectCreate
		 ...
		 * ("mbeans-descriptors/mbean/constructor/descriptor/field");
		 * digester.addSetNext
		 * ("mbeans-descriptors/mbean/constructor/descriptor/field", "addField",
		 * "org.apache.tomcat.util.modeler.FieldInfo");
		 * 
		 * digester.addObjectCreate
		 ...
		 * ("mbeans-descriptors/mbean/constructor/parameter");
		 * digester.addSetNext
		 * ("mbeans-descriptors/mbean/constructor/parameter", "addParameter",
		 * "org.apache.tomcat.util.modeler.ParameterInfo");
		 * 
		 * digester.addObjectCreate
		 ...
		 * "org.apache.tomcat.util.modeler.FieldInfo");
		 * digester.addSetProperties
		 * ("mbeans-descriptors/mbean/descriptor/field"); digester.addSetNext
		 * ("mbeans-descriptors/mbean/descriptor/field", "addField",
		 * "org.apache.tomcat.util.modeler.FieldInfo");
		 */
		...
		digester.addSetNext(
				"mbeans-descriptors/mbean/notification/descriptor/field",
				"addField", "org.apache.tomcat.util.modeler.FieldInfo");
		...
		digester.addSetNext("mbeans-descriptors/mbean/operation",
				"addOperation", "org.apache.tomcat.util.modeler.OperationInfo");
		...
		digester.addSetNext("mbeans-descriptors/mbean/operation/parameter",
				"addParameter", "org.apache.tomcat.util.modeler.ParameterInfo");
