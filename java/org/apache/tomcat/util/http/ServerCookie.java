 ...
 *
 * Tomcat.core uses this recyclable object to represent cookies, and the facade
 * will convert it to the external representation.
 */
	...
	public static void appendCookieValue(StringBuffer headerBuf, int version,
		...
		if (newVersion == 0
				&& (!CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
						&& CookieSupport.isHttpToken(value) || CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
		...
		if (newVersion == 0
				&& (!CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
						&& CookieSupport.isHttpToken(path) || CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
		...
		if (newVersion == 0
				&& (!CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
						&& CookieSupport.isHttpToken(domain) || CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0
