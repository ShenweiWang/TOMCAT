 ...
 * their content either in memory, for smaller items, or in a temporary file on
 * disk, for larger items. The size threshold, above which content will be
 * stored on disk, is configurable, as is the directory in which temporary files
 * will be created.
 * </p>
 *
 * <p>
...
public class DiskFileItemFactory implements FileItemFactory {
	 ...
	 *
	 * @param pTracker
	 *            An instance of {@link FileCleaningTracker}, which will from
