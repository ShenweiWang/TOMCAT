...
public class HttpMessages {
	...
	/**
	 * Get the status string associated with a status code. No I18N - return the
	 * messages defined in the HTTP spec. ( the user isn't supposed to see them,
	 * this is the last thing to translate)
	 *
	 ...
	 * @param msg
	 *            The message to test
	 * @return <code>true</code> if the message is safe to use in an HTTP header
