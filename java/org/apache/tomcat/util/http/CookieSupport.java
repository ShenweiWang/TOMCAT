...
public final class CookieSupport {
	...
	static {
		...
		String alwaysAddExpires = System
		...
		/*
		 * Excluding the '/' char by default violates the RFC, but it looks like
		 * a lot of people put '/' in unquoted values: '/': ; //47 '\t':9 ' ':32
		 * '\"':34 '(':40 ')':41 ',':44 ':':58 ';':59 '<':60 '=':61 '>':62
