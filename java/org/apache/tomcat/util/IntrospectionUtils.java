...
public final class IntrospectionUtils {
	...
	public static boolean setProperty(Object o, String name, String value,
		...
		try {
			...
			log.warn(
					"IntrospectionUtils: SecurityException for " + o.getClass()
							+ " " + name + "=" + value + ")", ex1);
			...
			log.warn(
					"IntrospectionUtils: InvocationTargetException for "
	...
	public static void setProperty(Object o, String name) {
		...
		try {
			...
			if (log.isDebugEnabled())
				log.debug("IntrospectionUtils: Exception for " + o.getClass()
						+ " " + name, ex1);
		}
	}
