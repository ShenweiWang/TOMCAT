...
public class StringCache {
	 ...
	 */
	protected static HashMap<ByteEntry, int[]> bcStats = new HashMap<ByteEntry, int[]>(
			cacheSize);
	 ...
	 */
	protected static HashMap<CharEntry, int[]> ccStats = new HashMap<CharEntry, int[]>(
			cacheSize);
						...
						while (n < size) {
							...
							for (int i = 0; i < list.size() && n < size; i++) {
								...
								if (insertPos == n) {
									...
									System.arraycopy(tempbcCache,
											insertPos + 1, tempbcCache,
						...
						while (n < size) {
							...
							for (int i = 0; i < list.size() && n < size; i++) {
								...
								if (insertPos == n) {
									...
									System.arraycopy(tempccCache,
											insertPos + 1, tempccCache,
											insertPos + 2, n - insertPos - 1);
