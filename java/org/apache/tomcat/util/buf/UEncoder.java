...
/**
 * Efficient implementation for encoders. This class is not thread safe - you
 * need one encoder per thread. The encoder will save and recycle the internal
 * objects, avoiding garbage.
 *
 * You can add extra characters that you want preserved, for example while
 * encoding a URL you can add "/".
 *
