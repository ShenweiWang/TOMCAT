...
public class Multicast {
	 ...
	 * @param source
	 *            Source Address to accept transmissions from (non-NULL implies
	 ...
	 * @param ttl
	 *            Time to live to Assign. 0-255, default=1 <br />
	 *            <b>Remark :</b> If the TTL is 0, packets will only be seen by
	 *            sockets on the local machine, and only when multicast loopback
	 *            is enabled.
	 */
