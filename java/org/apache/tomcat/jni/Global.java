...
public class Global {
	 ...
	 * processes and threads. Note: There is considerable overhead in using this
	 * API if only cross-process or cross-thread mutual exclusion is required.
	 * See apr_proc_mutex.h and apr_thread_mutex.h for more specialized lock
	 * routines. <br />
	 ...
	 * @param pool
	 *            The pool to operate on. This function must be called to
	 *            maintain portability, even if the underlying lock mechanism
	 *            does not require it.
