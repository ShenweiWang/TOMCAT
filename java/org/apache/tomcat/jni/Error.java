...
public class Error extends Exception {
	 ...
	 *         on most platforms This retrieves errno, or calls a GetLastError()
	 *         style function, and folds it with APR_FROM_OS_ERROR. Some
	 *         platforms (such as OS2) have no such mechanism, so this call may
	 *         be unsupported. Do NOT use this call for socket errors from
	 ...
	 *         This retrieves errno or calls a GetLastSocketError() style
	 *         function, and folds it with APR_FROM_OS_ERROR.
	 */
