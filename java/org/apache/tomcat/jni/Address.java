...
public class Address {
	 ...
	 */
	public static native long info(String hostname, int family, int port,
			int flags, long p) throws Exception;
	...
	/**
	 * Return the IP address (in numeric address string format) in an APR socket
	 * address. APR will allocate storage for the IP address string from the
	 * pool of the apr_sockaddr_t.
	 * 
	 * @param sa
	 ...
	 * 
	 * @param which
	 *            Which interface do we want the apr_sockaddr_t for?
	 * @param sock
	 *            The socket to use
	 ...
	 * @param b
	 *            The other APR socket address. The return value will be True if
	 *            the addresses are equivalent.
	 */
