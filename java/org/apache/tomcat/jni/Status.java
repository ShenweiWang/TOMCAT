...
public class Status {
	...
	/**
	 * APR_OS_ERRSPACE_SIZE is the maximum number of errors you can fit into one
	 * of the error/status ranges below -- except for APR_OS_START_USERERR,
	 * which see.
	 */
	 ...
	 * immediately following this one is set ten times farther away than usual,
	 * so that users of apr have a lot of room in which to declare custom error
	 * codes.
	 */
	...
	/**
	 * APR_STATUS_IS Status Value Tests <br />
	 * <b>Warning :</b> For any particular error condition, more than one of
	 * these tests may match. This is because platform-specific error codes may
	 * not always match the semantics of the POSIX codes these tests (and the
	 * corresponding APR error codes) are named after. A notable example are the
	 * APR_STATUS_IS_ENOENT and APR_STATUS_IS_ENOTDIR tests on Win32 platforms.
	 * The programmer should always be aware of this and adjust the order of the
	 * tests accordingly.
	 *
	 */
