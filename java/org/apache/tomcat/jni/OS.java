...
public class OS {
	...
	/**
	 * Get the name of the current locale character set. Defers to
	 * apr_os_default_encoding if the current locale's data can't be retrieved
	 * on this system.
	 * 
	 * @param pool
	 *            the pool to allocate the name from, if needed
	 ...
	 * 
	 * @param inf
	 *            array that will be filled with system information. Array
	 ...
	 * 
	 * @param level
	 *            Log message severity. See LOG_XXX enums.
	 * @param message
	 *            Message to log
	 */
