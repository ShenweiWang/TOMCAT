...
public class BodyContentImpl extends BodyContent {
	 ...
	 * releasing all internal references, and preparing it for potential reuse
	 * by a later invocation of {@link PageContextImpl#pushBody(Writer)}.
	 *
	 * <p>
	 * Note, that BodyContentImpl instances are usually owned by a
	 * PageContextImpl instance, and PageContextImpl instances are recycled and
	 * reused.
	 *
