 ...
 * allows for the emulation of numerous fragments within a single class, which
 * in turn reduces the load on the class loader since there are potentially many
