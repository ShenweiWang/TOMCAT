 ...
 * 
 * This needs revisiting when the buffering problems in the JSP spec are fixed
 * -akv
 *
...
public class JspWriterImpl extends JspWriter {
	...
	public void write(char cbuf[], int off, int len) throws IOException {
		...
		if (len >= bufferSize) {
			 ...
			 * flush the buffer and then write the data directly. In this way
	 ...
	 * character (<code>'\n'</code>).
	 *
	 * Need to change this from PrintWriter because the default println() writes
	 * to the sink directly instead of through the write method...
	 */
	@Override
