...
/**
 * Class loader for loading servlet class files (corresponding to JSP files) and
 * tag handler class files (corresponding to tag files).
 *
...
public class JasperLoader extends URLClassLoader {
	 ...
	 *
	 * Since this ClassLoader is only used for a JSP page in a web application
