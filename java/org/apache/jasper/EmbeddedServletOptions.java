...
public final class EmbeddedServletOptions implements Options {
	...
	/**
	 * Should jsps be unloaded if to many are loaded? If set to a value greater
	 * than 0 eviction of jsps is started. Default: -1
	 */
	@Override
	...
	/**
	 * Should any jsps be unloaded when being idle for this time in seconds? If
	 * set to a value greater than 0 eviction of jsps is started. Default: -1
	 */
	@Override
	...
	public EmbeddedServletOptions(ServletConfig config, ServletContext context) {
		...
		if (recompileOnFail != null) {
			if (recompileOnFail.equalsIgnoreCase("true")) {
				...
				if (log.isWarnEnabled()) {
					log.warn(Localizer
							.getMessage("jsp.warning.recompileOnFail"));
				}
			}
		}
