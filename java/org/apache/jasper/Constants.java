...
public class Constants {
	 ...
	 * go.
	 */
	public static final String SERVICE_METHOD_NAME = System.getProperty(
			"org.apache.jasper.Constants.SERVICE_METHOD_NAME", "_jspService");
	...
	public static final List<String> STANDARD_IMPORTS = Collections
			.unmodifiableList(Arrays.asList(PRIVATE_STANDARD_IMPORTS));

	/**
	 * ServletContext attribute for classpath. This is tomcat specific. Other
	 * servlet engines may choose to support this attribute if they want to have
	 * this JSP engine running on them.
	 */
	public static final String SERVLET_CLASSPATH = System.getProperty(
			"org.apache.jasper.Constants.SERVLET_CLASSPATH",
			"org.apache.catalina.jsp_classpath");

	/**
	 * Request attribute for <code>&lt;jsp-file&gt;</code> element of a servlet
	 * definition. If present on a request, this overrides the value returned by
	 * <code>request.getServletPath()</code> to select the JSP page to be
	 * executed.
	 */
	public static final String JSP_FILE = System.getProperty(
	 ...
	 */
	public static final String PRECOMPILE = System.getProperty(
			"org.apache.jasper.Constants.PRECOMPILE", "jsp_precompile");

	/**
	 * The default package name for compiled jsp pages.
	 */
	public static final String JSP_PACKAGE_NAME = System.getProperty(
			"org.apache.jasper.Constants.JSP_PACKAGE_NAME", "org.apache.jsp");

	/**
	 * The default package name for tag handlers generated from tag files
	 */
	public static final String TAG_FILE_PACKAGE_NAME = System.getProperty(
			"org.apache.jasper.Constants.TAG_FILE_PACKAGE_NAME",
			"org.apache.jsp.tag");

	// Must be kept in sync with org/apache/catalina/Globals.java
	public static final String ALT_DD_ATTR = System.getProperty(
	...
	private static final String[] PRIVATE_CACHED_DTD_PUBLIC_IDS = {
			TAGLIB_DTD_PUBLIC_ID_11, TAGLIB_DTD_PUBLIC_ID_12,
			WEBAPP_DTD_PUBLIC_ID_22, WEBAPP_DTD_PUBLIC_ID_23, };
	public static final List<String> CACHED_DTD_PUBLIC_IDS = Collections
			.unmodifiableList(Arrays.asList(PRIVATE_CACHED_DTD_PUBLIC_IDS));
	private static final String[] PRIVATE_CACHED_DTD_RESOURCE_PATHS = {
			TAGLIB_DTD_RESOURCE_PATH_11, TAGLIB_DTD_RESOURCE_PATH_12,
			WEBAPP_DTD_RESOURCE_PATH_22, WEBAPP_DTD_RESOURCE_PATH_23, };
	public static final List<String> CACHED_DTD_RESOURCE_PATHS = Collections
			.unmodifiableList(Arrays.asList(PRIVATE_CACHED_DTD_RESOURCE_PATHS));
	 ...
	 */
	public static final String TEMP_VARIABLE_NAME_PREFIX = System.getProperty(
	 ...
	 */
	public static final String SESSION_PARAMETER_NAME = System.getProperty(
			"org.apache.catalina.SESSION_PARAMETER_NAME", "jsessionid");
	 ...
	 */
	public static final String DEFAULT_JAR_SKIP_PROP = "tomcat.util.scan.DefaultJarScanner.jarsToSkip";

	/**
	 * Name of system property containing additional list of JARs to skip when
	 * scanning for TLDs.
	 */
	public static final String TLD_JAR_SKIP_PROP = "org.apache.catalina.startup.TldConfig.jarsToSkip";
