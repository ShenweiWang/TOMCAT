...
public interface Options {
	 ...
	 * Instantiation error if the class attribute specified in useBean action is
	 * invalid.
	 */
	 ...
	 * file. Ignored if suppressSmap() is true.
	 */
	...
	/**
	 * The cache for the location of the TLD's for the various tag libraries
	 * 'exposed' by the web application. A tag library is 'exposed' either
	 * explicitly in web.xml or implicitly via the uri tag in the TLD of a
	 * taglib deployed in a jar file (WEB-INF/lib).
	 *
	 * @return the instance of the TldLocationsCache for the web-application.
	 */
	 ...
	 * jsps loaded, they will be unloaded. If unset or less than 0, no jsps are
	 * unloaded.
	 */
	public int getMaxLoadedJsps();

	/**
	 * The idle time in seconds after which a JSP is unloaded. If unset or less
	 * or equal than 0, no jsps are unloaded.
	 */
