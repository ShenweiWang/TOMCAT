...
public class UTF8Reader extends Reader {
	...
	public void mark(int readAheadLimit) throws IOException {
		throw new IOException(Localizer.getMessage(
				"jsp.error.xml.operationNotSupported", "mark()", "UTF-8"));
	}
	...
	private void expectedByte(int position, int count)
		...
		throw new UTFDataFormatException(Localizer.getMessage(
				"jsp.error.xml.expectedByte", Integer.toString(position),
	...
	private void invalidByte(int position, int count)
		...
		throw new UTFDataFormatException(Localizer.getMessage(
				"jsp.error.xml.invalidByte", Integer.toString(position),
				Integer.toString(count)));
	}
