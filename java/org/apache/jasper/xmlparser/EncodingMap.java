...
public class EncodingMap {
	...
	/** fIANA2JavaMap */
	protected static final Hashtable<String, String> fIANA2JavaMap = new Hashtable<String, String>();

	/** fJava2IANAMap */
	protected static final Hashtable<String, String> fJava2IANAMap = new Hashtable<String, String>();
	...
	static {
		...
		fIANA2JavaMap.put("EXTENDED_UNIX_CODE_PACKED_FORMAT_FOR_JAPANESE",
				"EUCJIS");
