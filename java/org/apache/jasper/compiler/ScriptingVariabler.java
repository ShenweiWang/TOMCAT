...
/**
 * Class responsible for determining the scripting variables that every custom
 * action needs to declare.
 *
 * @author Jan Luehe
 */
class ScriptingVariabler {
	...
	/*
	 * Assigns an identifier (of type integer) to every custom tag, in order to
	 * help identify, for every custom tag, the scripting variables that it
	 * needs to declare.
	 */
