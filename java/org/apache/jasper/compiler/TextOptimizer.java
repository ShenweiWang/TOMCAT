...
public class TextOptimizer {
	...
	static class TextCatVisitor extends Node.Visitor {
		...
		public void visit(Node.TemplateText n) throws JasperException {
			if ((options.getTrimSpaces() || pageInfo
					.isTrimDirectiveWhitespaces()) && n.isAllSpace()) {
		...
		/**
		 * This method breaks concatenation mode. As a side effect it copies the
		 * concatenated string to the first text node
		 */
