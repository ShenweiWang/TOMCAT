...
public class JspUtil {
	...
	private static String getClassNameBase(String urn) {
		StringBuilder base = new StringBuilder(Constants.TAG_FILE_PACKAGE_NAME
				+ ".meta.");
		if (urn != null) {
	 ...
	 * element type can be one of ZBCDFIJS or L<classname>; It is converted into
	 * forms that can be understood by javac.
	 */
