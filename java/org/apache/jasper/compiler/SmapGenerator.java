...
/**
 * Represents a source map (SMAP), which serves to associate lines of the input
 * JSP file(s) to lines in the generated servlet in the final .class file,
 * according to the JSR-045 spec.
 * 
 * @author Shawn Bayern
 */
public class SmapGenerator {
	...
	/*
	 * The SMAP syntax is reasonably straightforward. The purpose of this class
	 * is currently twofold: - to provide a simple but low-level Java interface
	 * to build a logical SMAP - to serialize this logical SMAP for eventual
	 * inclusion directly into a .class file.
	 */
	...
	/**
	 * Sets the filename (without path information) for the generated source
	 * file. E.g., "foo$jsp.java".
	 */
	...
	/**
	 * Adds the given SmapStratum object, representing a Stratum with logically
	 * associated FileSection and LineSection blocks, to the current
	 * SmapGenerator. If <tt>default</tt> is true, this stratum is made the
	 * default stratum, overriding any previously set default.
	 *
	 * @param stratum
	 *            the SmapStratum object to add
	 * @param defaultStratum
	 *            if <tt>true</tt>, this SmapStratum is considered to represent
	 *            the default SMAP stratum unless overwritten
	 */
	 ...
	 *            the SMAP to embed
	 * @param stratumName
	 *            the name of the stratum output by the compilation that
	 *            produced the <tt>smap</tt> to be embedded
	 */
	...
	/**
	 * Instructs the SmapGenerator whether to actually print any embedded SMAPs
	 * or not. Intended for situations without an SMAP resolver.
	 *
	 * @param status
	 *            If <tt>false</tt>, ignore any embedded SMAPs.
	 */
