 ...
 * This class provides access to the name of the Map used to store the dynamic
 * attribute names and values passed to the custom action invocation. This
 * information is used by the code generator.
 */
class JasperTagInfo extends TagInfo {

	private String dynamicAttrsMapName;

	public JasperTagInfo(String tagName, String tagClassName,
			...
			TagVariableInfo[] tvi, String mapName) {
