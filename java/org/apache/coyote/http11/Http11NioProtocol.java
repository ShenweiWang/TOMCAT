	...
	protected static class Http11ConnectionHandler extends
		...
		protected void initSsl(SocketWrapper<NioChannel> socket,
			...
			if (proto.isSSLEnabled() && (proto.sslImplementation != null)
				...
				processor.setSslSupport(proto.sslImplementation
						.getSSLSupport(ch.getSslEngine().getSession()));
			} else {
		...
		protected Processor<NioChannel> createUpgradeProcessor(
			...
			return new org.apache.coyote.http11.upgrade.UpgradeNioProcessor(
					socket, inbound, ((Http11NioProtocol) getProtocol())
							.getEndpoint().getSelectorPool());
		}
		...
		protected Processor<NioChannel> createUpgradeProcessor(
			...
			return new NioProcessor(socket, httpUpgradeProcessor, proto
					.getEndpoint().getSelectorPool(),
