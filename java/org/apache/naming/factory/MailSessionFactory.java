 ...
 * be used for managing inbound and outbound electronic mail messages via
 * JavaMail APIs. All messaging environment properties described in the JavaMail
...
public class MailSessionFactory implements ObjectFactory {
	 ...
	 *
	 * @param refObj
	 *            Reference information containing our parameters, or null if
	 *            there are no parameters
	 * @param name
	 *            The name of this object, relative to context, or null if there
	 *            is no name
	 * @param context
	 *            The context to which name is relative, or null if name is
