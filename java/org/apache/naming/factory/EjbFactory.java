	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx,
		...
		if (obj instanceof EjbRef) {
			...
			if (linkRefAddr != null) {
				...
				/*
				 * String homeClassName = ref.getClassName(); try { Class home =
				 * Class.forName(homeClassName); if (home.isInstance(beanObj)) {
				 * System.out.println("Bean of type " +
				 * beanObj.getClass().getName() + " implements home interface "
				 * + home.getName()); } else {
				 * System.out.println("Bean of type " +
				 * beanObj.getClass().getName() +
				 * " doesn't implement home interface " + home.getName()); throw
				 * new NamingException ("Bean of type " +
				 * beanObj.getClass().getName() +
				 * " doesn't implement home interface " + home.getName()); } }
			...
			if (factoryRefAddr != null) {
				...
				try {
					factory = (ObjectFactory) Class.forName(
							javaxEjbFactoryClassName).newInstance();
				} catch (Throwable t) {
