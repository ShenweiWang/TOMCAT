 ...
 * for development with IDEs. This should be used in conjunction with
 ...
 *
 *
 * <strong>This is not meant to be used for production. Its meant to ease
...
public class VirtualDirContext extends FileDirContext {
	...
	public Attributes getAttributes(String name) throws NamingException {
		...
		if (mappedResourcePaths != null) {
			for (Map.Entry<String, List<String>> mapping : mappedResourcePaths
					.entrySet()) {
