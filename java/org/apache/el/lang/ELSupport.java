...
public class ELSupport {
	 ...
	 * Byte).
	 * 
	 * Otherwise, check that the first object is an instance of Comparable, and
	 * compare against the second object. If that is null, return 1, otherwise
	 ...
	 * return -1, else return the result of comparing against the first object.
	 * 
	...
	public static final boolean equals(final Object obj0, final Object obj1)
		...
		if (obj0 == obj1) {
			...
			int lexCompare = coerceToString(obj0).compareTo(
					coerceToString(obj1));
	...
	public static final Character coerceToCharacter(final Object obj)
		...
		throw new ELException(MessageFactory.get("error.convert", obj, objType,
				Character.class));
	}
