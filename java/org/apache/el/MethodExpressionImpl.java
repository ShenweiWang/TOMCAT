 ...
 * {@link javax.el.Expression} javadocs.
 *
...
public final class MethodExpressionImpl extends MethodExpression implements
	 ...
	 * <code>null</code>, is an <code>Expression</code> object that is the of
	 * the same type (<code>ValueExpression</code> or
	 ...
	 * must produce the same integer result. Implementations must take special
	...
	/**
	 * @since EL 2.2 Note: The spelling mistake is deliberate.
